window.MATH_QUESTION_BANK_V2_U09 = [
  {
    ...
    "answerIndex": 0,
    "explanation": "甲組12棵、乙組15棵、丙組18棵，12+15+18=45棵。42是只加甲乙漏丙；33則少算丙組；48把18誤算成21。讀表時三組數字都要列入，漏掉一組就會得到偏小的總量。",
    "steps": [
      "確認三組棵數分別為12、15、18。",
      "三組相加：12+15+18。",
      "全班共45棵。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "飯類120票、麵類95票、其他35票，三類合計250票。飯類占比120÷250×100=48%。50是把總票數算成240；55則把120當分母，沒有用250票計算比例；52也不是依題意列式得到的答案。",
    "steps": [
      "總票數250票。",
      "飯類120票。",
      "120÷250×100=48%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "成長380−320=60，以2023年320為基準，60÷320×100=18.75%。15是60÷400；25是60÷240。成長率分母要用基準年，不能用成長後的數字。分母必須用2023年320這個基準，不能用400或240，15與本題列式結果不符。",
    "steps": [
      "成長額380−320=60萬。",
      "基準年2023為320萬。",
      "60÷320×100=18.75%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "45公斤以上含45−49、50−54、55−59三組，10+8+4=22人。18漏加55−59這一組；24多加了40−44區間；14只算45−49。「以上」要從45−49起算，三組次數都要列入，18與本題列式結果不符，24與本題列式結果不符。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "至少1次不含0次，35+25+10+5=75人。95把0次也加進去；55漏加10次或5次那一組；70則只加部分組別。讀次數表時「至少」的範圍不含0次那一列，95與本題列式結果不符。",
    "steps": [
      "至少1次不含0次組。",
      "35+25+10+5=75。",
      "共75人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "70分以下不含70−79，只含50−59與60−69，2+5=7人。5只算60−69；10誤含70−79；2只算50−59這一組。「以下」不含70−79這一組。7人只含50−59與60−69兩組，不能把70−79算進「以下」，5與本題列式結果不符。",
    "steps": [
      "70以下不含70−79。",
      "2+5=7人。",
      "共7人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總次數18+12+8+7=45，蘋果18次，18÷45×100=40%。36是18÷50誤算；45把總數當百分比；50是18÷36之類錯誤。分母要用全部次數45，不能用自創的50或36，36與本題列式結果不符。",
    "steps": [
      "總次數45次。",
      "蘋果18次。",
      "18÷45×100=40%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "21以上含21−30與31−40，14+8=22人。18漏加31−40的8人；26誤含11−20的9人；14只算21−30而漏31−40。讀「以上」時要確認起算區間，符合條件的組別次數都要相加，18與本題列式結果不符。",
    "steps": [
      "21以上含21−30、31−40。",
      "14+8=22。",
      "共22人。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "有寵物8+15+5=28人，總12+8+15+5=40人，28÷40×100=70%。60是24÷40誤算；65、55則分子分母搞錯。求占比時分子是該類次數，分母是全部次數，60與本題列式結果不符，65與本題列式結果不符。",
    "steps": [
      "有寵物28人，總40人。",
      "28÷40×100。",
      "占70%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200以下不含200−299，只含100以下與100−199，8+15=23人。35把200−299也加進去；40多加了300以上；27則少算某一組。讀「以下」時上限不含200−299這一組，35與本題列式結果不符。",
    "steps": [
      "200以下不含200−299組。",
      "8+15=23。",
      "共23人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "數學15人、英文9人，15−9=6人。8是15−7誤用社會科人數；4是9−5之類亂減；10把15+9相加。這題是兩科人數差，不是兩科相加，8與本題列式結果不符。",
    "steps": [
      "數學15人，英文9人。",
      "15−9=6。",
      "多6人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7或以上含7、8、9以上，12+10+3=25人。22漏加9以上那組；30誤含6那一組；15只算7這一組。讀「或以上」時要把符合條件的所有組別次數都列入，22與本題列式結果不符。",
    "steps": [
      "7或以上含7、8、9以上。",
      "12+10+3=25。",
      "共25人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "A班40人、B班55人、C班35人，40+55+35=130人。120漏加C班35人；140多加了10人；125則只加其中兩班。長條圖求總量時，題目所列各類人數都要列入，120與本題列式結果不符。",
    "steps": [
      "讀出A40、B55、C35。",
      "三數相加。",
      "合計130人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週一120件、週二95件，120−95=25件。15像110−95用了錯誤數字；30像120−90；20則不是這兩天相減。長條圖比較差量時，只能拿題幹指定的兩類相減，15與本題列式結果不符。",
    "steps": [
      "週一120件，週二95件。",
      "120−95=25。",
      "多25件。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三月22萬、二月18萬，22−18=4萬。3、5、2都不是22與18相減；題目只比較這兩個月。長條圖讀值後要鎖定題目指定的兩個月份再算差，3與本題列式結果不符。",
    "steps": [
      "二月18萬，三月22萬。",
      "22−18=4。",
      "成長4萬。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "題目只比較數學與英文，所以算92−78=14分。10、12、16都不是這兩科分數的差；這題是兩類差量，不是把所有科目分數加總，10與本題列式結果不符。",
    "steps": [
      "數學92分，英文78分。",
      "92−78=14。",
      "高14分。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "四區總人340，南部95人，95÷340×100≈28%。26像95÷365用了錯誤分母；30把95當分母；25是計算錯。占比要用該區人數除以四區總人數，26與本題列式結果不符。",
    "steps": [
      "總人340人。",
      "南部95人。",
      "95÷340×100≈28%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四個月共840元，840÷4=210元。200只拿一月數字；220只拿四月數字；215是除法算錯。求月平均要把各月數值都列入再除以月數，200與本題列式結果不符。",
    "steps": [
      "四個月加總840元。",
      "除以4個月。",
      "平均210元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "紅茶60杯、奶茶55杯，60−55=5杯。10像60−50；15像55−40；20則不是這兩類相減。長條圖比較兩類差量時，只能拿題幹指定的兩類相減，10與本題列式結果不符。",
    "steps": [
      "紅茶60杯，奶茶55杯。",
      "60−55=5。",
      "奶茶少5杯。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三店平均(300+250+280)÷3≈276.7元，不到290元。甲店300雖超過290，但題目問的是三店平均，不是單店最高。丙店280也沒有接近290；成立，丙店接近290也不是依題意列式得到的答案。",
    "steps": [
      "三店加總830元。",
      "830÷3≈277元。",
      "不到290，說法不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "3月15度、1月10度，15−10=5度。3、2、4用了其他月份組合，不是3月減1月。折線圖比較兩時點時，要鎖定題幹指定月份再相減，3與本題列式結果不符。",
    "steps": [
      "3月15度，1月10度。",
      "15−10=5。",
      "高5度。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週三48件、週二55件，48−55=−7件，減少7件。7是55−48方向反了；3、−3則不是這兩天相減。折線圖算變化量時，後值減前值才看得出增減方向，7與本題列式結果不符。",
    "steps": [
      "週二55，週三48。",
      "48−55=−7。",
      "減少7件。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較20、35、42、38，42最大，10時最多。8時是35；12時是38；6時是20，都不是最高。折線圖找最大值要在題幹所列各時點中比較，8時與本題列式結果不符。",
    "steps": [
      "讀出20、35、42、38。",
      "42最大。",
      "10時人數最多。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "四週80+90+85+95=350元，350÷4=87.5元。85只取第3週；90只取第2週；88是計算錯。折線圖求平均要把各週數值都列入再除以週數，85與本題列式結果不符。",
    "steps": [
      "四週加總350元。",
      "除以4週。",
      "平均87.5元。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "4月260元、1月200元，260−200=60元。40只算到2月；80用了260−180；50是計算錯。期間總變化要用題幹指定的兩端月份相減，40與本題列式結果不符，80與本題列式結果不符。",
    "steps": [
      "1月200，4月260。",
      "260−200=60。",
      "共增加60元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最高95分、最低88分，95−88=7分。5、8、4都不是95與88相減。折線圖求分差時，要先在圖上找出最高與最低兩點再相減，5與本題列式結果不符。",
    "steps": [
      "最高95，最低88。",
      "95−88=7。",
      "差7分。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "依題意，10時45人、12時50人，50−45=5人。10像50−40；3像45−42；8是計算錯。折線圖比較兩時點人數差，只能拿題幹指定的兩個時刻相減，10與本題列式結果不符。",
    "steps": [
      "12時50人，10時45人。",
      "50−45=5。",
      "多5人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五天30+45+40+50+35=200分鐘。180漏加50；210多加10；190少加10。折線圖求總量時，各天數值都要列入，不能漏掉任一天，180與本題列式結果不符，210與本題列式結果不符。",
    "steps": [
      "五天30、45、40、50、35。",
      "全部相加。",
      "共200分鐘。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "2月120件、3月110件，110−120=−10件，3月少10件。「多10」方向反了；少5則不是10。折線圖比較相鄰兩月時，後月減前月才看得出增減；一樣也不是依題意列式得到的答案。",
    "steps": [
      "2月120，3月110。",
      "110−120=−10。",
      "3月少10。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "圓形圖文字直接讀出單車占35%。25是步行占比；30是公車占比；65則把35與30相加。這題只問單車占比，不是兩類相加，25與本題列式結果不符。",
    "steps": [
      "找單車對應百分比。",
      "單車35%。",
      "占35%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "國文30%加英文25%，30+25=55%。50漏加5個百分點；45只算國文加自然；60多加5。圓形圖求兩類占比和時，要把題幹指定的兩項百分比相加，50與本題列式結果不符。",
    "steps": [
      "國文30%，英文25%。",
      "30+25=55。",
      "合計55%。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "A占45%，200×45%=90人。80是200×40%誤算；100是200×50%；45把占比當人數。占比換人數要用總人數200去乘該項45%。人數要用總人數200去乘45%，不能把占比45當成人數，80與本題列式結果不符。",
    "steps": [
      "總數200人，A占45%。",
      "200×0.45=90。",
      "A有90人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "藍35%、綠15%，差20個百分點；以綠15%為基準，增加率20÷15×100≈133%。20是差值不是增加率；35、15是占比本身。增加率要把差20除以基準15%，不能把差值本身當答案。",
    "steps": [
      "藍35%，綠15%，差20。",
      "基準綠15%。",
      "20÷15×100≈133%。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "南25%加北20%，25+20=45%。50多加了5；40少加5；55誤加東區30%。題目只問南、北兩區占比，不能把其他區域也加進去，50與本題列式結果不符，40與本題列式結果不符。",
    "steps": [
      "南25%，北20%。",
      "25+20=45。",
      "合計45%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "麵類30%，400×30%=120票。150像400×37.5%；200像400×50%；80則占比用錯。總票400乘30%才是120票，不能把其他占比誤當票數。120票是400張票乘30%，不能用錯誤的百分比去推算，150與本題列式結果不符。",
    "steps": [
      "總票400，麵30%。",
      "400×0.3=120。",
      "麵類120票。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "夏季120人占25%，總人120÷25%=480人。400像120÷30%；600像120÷20%；360是計算錯。已知部分人數與占比，總人數要用120除以25%反推。480人是120人除以夏季占比25%反推，不能用錯誤除數。",
    "steps": [
      "夏25%是120人。",
      "120÷0.25=480。",
      "全部約480人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "四天閱讀30、45、40、50分鐘，全部相加得165分鐘，再除以4天，平均41.25分鐘。40只取其中一天；42、43是加總或除法算錯，40與本題列式結果不符，42與本題列式結果不符。",
    "steps": [
      "四天加總165分鐘。",
      "除以4天。",
      "平均41.25分鐘。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "三數平均12，總和12×3=36；已知10、14，第三數36−10−14=12。11、13是計算錯誤；15則總和會超過36。平均數反推未知數時，要先算總和再減已知數；16也不是依題意列式得到的答案。",
    "steps": [
      "三數和12×3=36。",
      "36−10−14=12。",
      "第三數12。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "平均80分、30人，總分應為80×30=2400分。800像只乘10人；240像用80+160誤算；2000則人數用錯。平均乘人數才是總分，不能直接把兩個數字相加，800與本題列式結果不符。",
    "steps": [
      "平均80分，30人。",
      "80×30=2400。",
      "總分2400。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五數平均12，總和60；已知8、10、12、14，未知數x=60−8−10−12−14=16。14是已知數之一；12是平均本身；18則總和會超過60。18會讓五數總和超過60，與平均12不符，14與本題列式結果不符。",
    "steps": [
      "五數和12×5=60。",
      "減去8、10、12、14得16。",
      "x=16。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "四天平均2500元，總額2500×4=10000元。2500是平均不是四天總額；7500、5000則天數或乘法用錯。平均乘天數才是總額，2500與本題列式結果不符，7500與本題列式結果不符。",
    "steps": [
      "平均2500元，4天。",
      "2500×4=10000。",
      "共10000元。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "六個數平均15，總和15×6=90。15是平均數本身；75像15×5只乘5個數；60則個數用錯。反推總和時，平均要乘正確的資料個數。90是15乘6個數，不能只乘5個或把15當總和。",
    "steps": [
      "平均15，6個數。",
      "15×6=90。",
      "總和90。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "去掉最低70分後，80+85+90+75=330，330÷4=82.5。80只取其中一次分數；85、83則加總或除法算錯。去掉極值後要重算剩餘四次測驗的平均。330除以4得82.5，80只是其中一次測驗分數，不是平均。",
    "steps": [
      "去掉最低70。",
      "剩330分，4次。",
      "新平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "設原n人，75n+80=76(n+1)，解方程可得n=4。若把原人數改為5人、3人或6人逐個試算，新平均都不會是76分，只有原為4人時平均才會變76分，5與本題列式結果不符。",
    "steps": [
      "設原n人，75n+80=76(n+1)。",
      "解得n=4。",
      "原4人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "四個數 8、10、12、14 已排好序，偶數個資料要取中間兩數 10 與 12 的平均，(10+12)÷2=11。10 或 12 都只取了其中一個中間數；13 則不是由 10 與 12 平均得到，10與本題列式結果不符。",
    "steps": [
      "排序8、10、12、14。",
      "中間兩數10、12。",
      "平均11。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "先把5、3、8、6、4排成3、4、5、6、8。共有5個資料，正中央第3個是5，所以中位數是5。4與6分別是中央左右兩側的數；8是最大值，不能當中位數，4與本題列式結果不符。",
    "steps": [
      "排序3、4、5、6、8。",
      "第3個是5。",
      "中位數5。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "六人分數70、75、80、85、90、95已排序，偶數個資料要取中間兩數80與85的平均，(80+85)÷2=82.5。80或85只取其中一個中間數；77.5則像用錯位置的兩數平均，80與本題列式結果不符。",
    "steps": [
      "排序70、75、80、85、90、95。",
      "中間80、85。",
      "平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五個2全部相同，排序後正中央仍是2，共有5個資料，中位數就是2。0、10、4都不在這組分數中，不能拿來當中位數，0與本題列式結果不符。",
    "steps": [
      "五個都是2。",
      "排序後中間是2。",
      "中位數2。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "七個數10、20、30、40、50、60、70已排序，奇數個資料取第4個，也就是40。30是第3個、50是第5個；35則像把30與40平均，但七個數不需這樣算。七個數只需取排序後第4個40，不必把30與40再平均。",
    "steps": [
      "七數已排序。",
      "第4個是40。",
      "中位數40。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "原四數15、25、35、45的中位是(25+35)÷2=30；加入50後排成15、25、35、45、50，正中央第3個變35。30是加入前的中位；40、45都不是新的正中央。加入50後中位變第3個35，30是加入前的中位。",
    "steps": [
      "加入50後排序。",
      "五數正中央35。",
      "新中位數35。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "身高155、160、165、168、170已排序，五人奇數個，正中央第3個是165。160是第2個、168是第4個；166.5像把160與168平均，不是本題中位。165是五人排序後第3個，166.5不是兩側身高平均。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "八個數3、7、11、15、19、23、27、31已排序，偶數個取第4、5兩數15與19平均，(15+19)÷2=17。15或19只取單一個；16則不是15與19的平均。中位是15與19的平均17，16不是這兩數的平均，15與本題列式結果不符。",
    "steps": [
      "中間兩數15、19。",
      "(15+19)÷2=17。",
      "中位數17。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "100、200、300、400、500、600成等差數列，偶數個取中間300與400平均得中位350，算術平均也是350。若只取300或400其中一個，不能代表中位數。350同時是六數的中位與平均，但不能只取300或400之一。",
    "steps": [
      "平均350。",
      "中位(300+400)÷2=350。",
      "兩者相同。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "3、5、5、7、9中，5出現2次最多，眾數是5。3、7、9各只出現1次，次數較少，不能當眾數。眾數是出現最多次的數，不是最大或最小的數，3與本題列式結果不符。",
    "steps": [
      "數出各數次數。",
      "5出現2次最多。",
      "眾數5。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "五次分數10、15、20、25、30中，最大30、最小10，全距30−10=20。15像20−5亂減、25像30−5；10則是最小值本身，不是全距。全距是最大值減最小值，15與本題列式結果不符。",
    "steps": [
      "最大30，最小10。",
      "30−10=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "2、4、4、6、4、8中，4出現3次最多，眾數是4。2、6、8次數較少；6雖在中间位置，但不是出現最多次的數。眾數要看次數，不是看位置，2與本題列式結果不符。",
    "steps": [
      "4出現3次。",
      "其他次數較少。",
      "眾數4。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "分數12、18、15、22、9中，最大22、最小9，全距22−9=13。10、15、7都不是22與9相減的結果。全距就是這五個分數的最大減最小。13只能由最大22減最小9得到，不能用其他兩數亂減。",
    "steps": [
      "最大22，最小9。",
      "22−9=13。",
      "全距13。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "尺碼5、5、8、8、10中，5和8都出現2次，同為眾數，所以有2個眾數。10只出現1次；1個或3個都不符合實際次數，1與本題列式結果不符，0與本題列式結果不符。",
    "steps": [
      "5出現2次，8出現2次。",
      "同為最多。",
      "有2個眾數。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "100、105、110、115、120中，最大120、最小100，全距120−100=20。15、10、25都不是最大減最小的結果。等差數列仍用最大減最小。20是120減100，等差數列仍要取頭尾相減，15與本題列式結果不符。",
    "steps": [
      "最大120，最小100。",
      "120−100=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7、3、7、5、7、9中，7出現3次最多，眾數是7。3、5、9各只出現1次，不能當眾數。眾數是出現次數最多的數，不是任意挑一個7，3與本題列式結果不符。",
    "steps": [
      "7出現3次。",
      "其他各1次。",
      "眾數7。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "45、52、38、61、55中，最大61、最小38，全距61−38=23。17、20、15都不是61與38相減。全距反映這五筆分數從最小值到最大值的差距。23是61減38，17與20都不是這兩數相減，17與本題列式結果不符。",
    "steps": [
      "最大61，最小38。",
      "61−38=23。",
      "全距23。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "20、25、30、35、40中，最大40、最小20，全距40−20=20。0像把全距與平均混談；10是30−20、5是25−20，都不是全距。全距是最大減最小。全距20是40減20，不能把中間兩數相減，0與本題列式結果不符。",
    "steps": [
      "最大40，最小20。",
      "40−20=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "鞋號36、37、37、38、39、37中，37出現3次最多，眾數是37；最大39、最小36，全距39−36=3。36是最小值不是眾數；全距4則把36誤當35。眾數是37不是36；全距3是39減36不是4；36；3也不是依題意列式得到的答案。",
    "steps": [
      "37出現3次最多。",
      "最大39最小36。",
      "眾數37，全距3。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "加權和80×2+90×3+70×1=500，權重和6，500÷6≈83.33分。80是三科簡單平均；85、82則加權計算錯誤。加權平均要把各項乘權重後相加，再除以權重和，80與本題列式結果不符。",
    "steps": [
      "加權和500。",
      "權重和6。",
      "500÷6≈83.33。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "A班20人共1500、B班30人共2550，合4050分、50人，4050÷50=81分。80是(75+85)÷2誤把兩班平均直接平均；82、79是計算錯。兩班合計平均要用總分除以總人數，80與本題列式結果不符。",
    "steps": [
      "A總1500，B總2550。",
      "合4050，50人。",
      "平均81。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總價2×50+3×40=220元，總重5公斤，220÷5=44元/公斤。45是(50+40)÷2誤算；46、42是計算錯。混合單價要用總價除以總重量，不能兩單價直接平均，45與本題列式結果不符。",
    "steps": [
      "總價220元。",
      "總重5公斤。",
      "平均44元/公斤。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "80×30%+90×50%+70×20%=24+45+14=83分。84、85是乘法或加總錯誤；82則少加態度這一項。三項分別乘30%、50%、20%後相加。態度占20%的那項70也要乘上，漏乘會少算，84與本題列式結果不符。",
    "steps": [
      "24+45+14=83。",
      "權重和100%。",
      "總評83分。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "上午5000、下午12000，合17000元、300件，17000÷300≈56.67元。55是(50+60)÷2誤算；57、58是計算錯。全天平均要用總銷售額除以總件數，55與本題列式結果不符，57與本題列式結果不符。",
    "steps": [
      "上午5000，下午12000。",
      "合17000，300件。",
      "平均≈56.67元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "男2550、女4000，合6550公分、40人，6550÷40=163.75公分。165是(170+160)÷2誤算；162、164是計算錯。全班平均要用兩性總身高除以40人。163.75是把6550除以40人，不能把兩性身高直接平均。",
    "steps": [
      "男2550，女4000。",
      "合6550，40人。",
      "平均163.75cm。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "三種肥料總價20+24+12=56元、6包，56÷6≈9.33元/包。10只算甲包單價；9、8.67是計算錯。混合平均要用總價除以總包數，10與本題列式結果不符，9與本題列式結果不符。",
    "steps": [
      "總價56元。",
      "6包。",
      "平均≈9.33元/包。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "甲組280、乙組480，合760分、10人，760÷10=76分。75是(70+80)÷2誤算；77、74是計算錯。合計平均要用兩組總分除以10人，75與本題列式結果不符，77與本題列式結果不符。",
    "steps": [
      "甲280，乙480。",
      "合760，10人。",
      "平均76。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "85×20%+90×50%+80×30%=17+45+24=86分。85像漏加某一項；87、84是計算錯。平時、段考、期末要分別乘20%、50%、30%後相加。三項分別乘20%、50%、30%後相加得86，85像少加一項，85與本題列式結果不符。",
    "steps": [
      "17+45+24=86。",
      "占比和100%。",
      "總成績86。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "花生600元加杏仁1000元，總價1600元、500g，1600÷500=3.2元/g。3.5是(2+5)÷2誤算；3、2.8是計算錯。混合平均單價要用總價除以總重量，3.5與本題列式結果不符，3與本題列式結果不符。",
    "steps": [
      "總價1600元。",
      "總重500g。",
      "平均3.2元/g。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "加權總和85×6=510，國文80×2+數學90×3=430，英文510−430=80分。85是加權平均本身；82、78是反推錯誤。反推未知項要先算已知項加權和，85與本題列式結果不符。",
    "steps": [
      "加權和510。",
      "已用430。",
      "英文80。"
