window.MATH_QUESTION_BANK_V2_U09 = [
  {
    ...
    "answerIndex": 0,
    "explanation": "甲組12加乙組15加丙組18，12+15+18=45棵。42是只加甲乙漏丙；33則少算丙組；48把18誤算成21。讀表加總時三組數字都要列入，不可漏列。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "確認三組棵數分別為12、15、18。",
      "三組相加：12+15+18。",
      "全班共45棵。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週一80元、週三70元，80−70=10元。15是把95−80誤當題意；25用95−70，比較的不是週一與週三。讀表比較要先鎖定題目指定的兩天再相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "週一銷售80元，週三70元。",
      "求週一減週三。",
      "80−70=10元。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "女生36人、男生24人，36−24=12人。10是計算錯誤；16把24−36方向弄反。比較誰多誰少，用大數減小數，單位仍為人。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "男生24人，女生36人。",
      "女生減男生。",
      "36−24=12人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總票120+95+35=250，飯類120，120÷250×100=48%。50是120÷240誤算；55把120當分母。分母必須是題目全部票數之和，不能只用部分資料。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "總票數250票。",
      "飯類120票。",
      "120÷250×100=48%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "B班84減A班78，84−78=6分。4是82−78之類算錯；10則84−74誤用。兩班平均直接相減即可，不必再除以人數，單位仍為分。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "A班平均78分。",
      "B班平均84分。",
      "84−78=6分。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "總票數是120+95+35=250，飯類有120票，所以比例為120÷250×100%=48%。50是把總票數算錯，55則不是由120除以250得到的正確百分比。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "最高25、最低18，全距25−18=7℃。5是把25−20誤當全距；6是22−16之類計算錯。全距定義是最大值減最小值，不是任意兩數相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "六天中最高25、最低18。",
      "全距=最大−最小。",
      "25−18=7℃。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "支持比反對多40人，以反對80為基準，40÷80×100=50%。40是把差當百分比；60、75則基準或差值算錯。增加率要清楚基準量是誰。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "支持120、反對80，差40人。",
      "基準是反對80人。",
      "40÷80×100=50%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "成長380−320=60，以2023年320為基準，60÷320×100=18.75%。15是60÷400；25是60÷240。成長率分母要用基準年，不能用成長後的數字。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "成長額380−320=60萬。",
      "基準年2023為320萬。",
      "60÷320×100=18.75%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "各組次數相加8+12+10+5=35人。錯選30是漏加某一組次數，40則多加一組，33則把四組次數加總算錯。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "列出四組次數8、12、10、5。",
      "四組相加。",
      "總人數35人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "各組次數15最大，對應80−89分。70−79是7次；90−99是5次；60−69只有3次。找最多人數要比較各組次數，不是比區間大小。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "讀出各組次數3、7、15、5。",
      "15最大。",
      "80−89分人數最多。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "45以上含45−49、50−54、55−59三組，10+8+4=22人。18漏加55−59；24多加了40−44；14只算45−49。讀表時要確認「以上」包含哪些組別。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "至少1次不含0次，35+25+10+5=75人。95把0次也加進去；55漏加10次或5次；70計算不完整。次數表求「至少」要排除指定組別。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "至少1次不含0次組。",
      "35+25+10+5=75。",
      "共75人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "70以下不含70−79，只含50−59與60−69，2+5=7人。5只算60−69；10誤含70−79；2只算50−59。邊界要分清「以下」是否含該分數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "70以下不含70−79。",
      "2+5=7人。",
      "共7人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總次數18+12+8+7=45，蘋果18，18÷45×100=40%。36是18÷50誤算；45把總數當百分比；50是18÷36之類錯誤。分母要用全部次數45，不能用自創的50或36。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "總次數45次。",
      "蘋果18次。",
      "18÷45×100=40%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "21以上含21−30與31−40，14+8=22人。18漏加31−40；26誤含11−20；14只算21−30。讀表時要確認邊界組別是否納入，以上通常含該起點組別。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "21以上含21−30、31−40。",
      "14+8=22。",
      "共22人。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "有寵物8+15+5=28人，總12+8+15+5=40人，28÷40×100=70%。60是24÷40誤算；65、55則分子分母搞錯。求占比時分子是該類次數，分母是全部次數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "有寵物28人，總40人。",
      "28÷40×100。",
      "占70%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200以下不含200−299，只含100以下與100−199，8+15=23人。35把200−299也加進去；40多加了300以上；27計算不完整。邊界用語決定要加哪些組別。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "200以下不含200−299組。",
      "8+15=23。",
      "共23人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "數學15人、英文9人，15−9=6人。8是15−7誤用社會；4是9−5之類；10把15+9相加。次數表比較兩組直接相減次數即可。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "數學15人，英文9人。",
      "15−9=6。",
      "多6人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7或以上含7、8、9以上，12+10+3=25人。22漏加9以上；30誤含6；15只算7。讀表時「或以上」要把起點組與更高組別全部加總。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "7或以上含7、8、9以上。",
      "12+10+3=25。",
      "共25人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "三班相加40+55+35=130人。120漏加C班；140多加了10人；125計算不完整。長條圖文字資料求總量要把各類別數字全部加總。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "讀出A40、B55、C35。",
      "三數相加。",
      "合計130人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週一120、週二95，120−95=25件。15是110−95；30是120−90；20計算錯誤。比較兩類別用大數減小數，要鎖定題目指定的兩天。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "週一120件，週二95件。",
      "120−95=25。",
      "多25件。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較80、65、45、30，80最大，蘋果汁最高。柳橙汁65次之；葡萄汁45；其他30最少。找最高要比較全部類別數值，不是看排列順序。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "讀出四類銷量80、65、45、30。",
      "80最大。",
      "蘋果汁銷量最高。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三月22減二月18，22−18=4萬。3是20−17之類；5是22−17；2是18−16。成長量用後期減前期，單位仍為萬元。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "二月18萬，三月22萬。",
      "22−18=4。",
      "成長4萬。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四社相加30+25+20+15=90人。75漏加桌球社；85少加15；70只加前三社。文字長條圖求總量要把題目列出的各類全部加總。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "四社人數30、25、20、15。",
      "全部相加。",
      "共90人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "數學92、英文78，92−78=14分。10是92−82；12是88−78；16是92−76。比較兩科分數直接相減，不必再除以人數。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "數學92分，英文78分。",
      "92−78=14。",
      "高14分。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "東區50戶最多、南區38戶最少，相差50−38=12戶。錯選10是把45減35之類錯用數字，15是50減35，8則比12更小且不是由50與38相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "最多50，最少38。",
      "50−38=12。",
      "相差12戶。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "總人120+85+95+40=340，南部95，95÷340×100≈27.9%，約28%。26是95÷365誤算；30把95當分母；25計算錯。百分比分母必須是四區人數總和340。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "總人340人。",
      "南部95人。",
      "95÷340×100≈28%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四個月200+240+180+220=840，840÷4=210元。200只取1月；220只取4月；215計算錯。平均要先加總再除以月份數。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "四個月加總840元。",
      "除以4個月。",
      "平均210元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "紅茶60、奶茶55，60−55=5杯。10是60−50；15是55−40；20計算錯。誰多誰少要看數值大小，紅茶較多，用紅茶減奶茶。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "紅茶60杯，奶茶55杯。",
      "60−55=5。",
      "奶茶少5杯。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三店平均(300+250+280)÷3=830÷3≈276.7元，不到290。甲店300超過290但平均不是看單一最高；中位也不是判斷平均的標準。文字結論要配合計算。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "三店加總830元。",
      "830÷3≈277元。",
      "不到290，說法不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "3月15、1月10，15−10=5度。3是12−10只比2月；2是13−11；4是14−10。題目指定3月與1月，要用15減10，不能用其他月份。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "3月15度，1月10度。",
      "15−10=5。",
      "高5度。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週三48減週二55，48−55=−7件，減少7件。7是55−48方向反；3是52−49；−3計算錯。相鄰變化用後期減前期，負號表示下降。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "週二55，週三48。",
      "48−55=−7。",
      "減少7件。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較20、35、42、38，42最大，10時最多。8時35次之；12時38；6時20最少。折線圖找最高點要比較全部時點數值。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "讀出20、35、42、38。",
      "42最大。",
      "10時人數最多。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "四週80+90+85+95=350，350÷4=87.5元。85只取第3週；90只取第2週；88計算錯。折線圖求平均要把各時點全部加總再除以個數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "四週加總350元。",
      "除以4週。",
      "平均87.5元。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "4月260減1月200，260−200=60元。40是220−200只到2月；80是260−180；50計算錯。期間總變化用終點減起點，不是逐段相加。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "1月200，4月260。",
      "260−200=60。",
      "共增加60元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最高95、最低88，95−88=7分。5是92−87；8是95−87；4是90−86。折線圖全距式差量要先找最大最小再相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "最高95，最低88。",
      "95−88=7。",
      "差7分。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較10時45人與12時50人，50−45=5人。10是50−40；3是45−42；8計算錯。相鄰時點比較直接相減，要鎖定題目指定的兩個時間。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "12時50人，10時45人。",
      "50−45=5。",
      "多5人。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "相鄰增幅：1→2增3、2→3增4、3→4減3、4→5增6，4到5月增6最大。錯選3到4月是下降不是增幅，1到2月只增3件，2到3月只增4件。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "算各相鄰差：3、4、−3、6。",
      "6最大。",
      "4月到5月增幅最大。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五天30+45+40+50+35=200分鐘。180漏加50；210多加10；190少加10。折線圖文字資料求總量要把各時點全部加總。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "五天30、45、40、50、35。",
      "全部相加。",
      "共200分鐘。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "2月120、3月110，110−120=−10，3月少10。多10方向反；一樣明顯不對；少5計算錯。折線圖判斷升降用後期減前期看正負。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "2月120，3月110。",
      "110−120=−10。",
      "3月少10。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "蘋果40%減香蕉30%，40−30=10個百分點。30是香蕉占比；40是蘋果占比本身；70是40+30相加。蘋果40%減香蕉30%，差10個百分點。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "蘋果40%，香蕉30%。",
      "40−30=10。",
      "多10個百分點。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "圓形圖直接讀單車35%。25是步行；30是公車；65是35+30誤加。各部分占比已在文字中給出，直接對應類別即可。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "找單車對應百分比。",
      "單車35%。",
      "占35%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "國文30加英文25，30+25=55%。50漏加5；45只算國文加自然；60多加5。圓形圖求合計占比把相關部分百分比相加。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "國文30%，英文25%。",
      "30+25=55。",
      "合計55%。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "A占45%，200×45%=200×0.45=90人。80是200×40%；100是200×50%；45把百分比當人數。百分比換算人數用總數乘占比。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "總數200人，A占45%。",
      "200×0.45=90。",
      "A有90人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "藍35、綠15，差20，以綠15為基準，20÷15×100≈133%。20是百分點差不是增加率；35是藍占比；15是綠占比。增加率基準要清楚。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "藍35%，綠15%，差20。",
      "基準綠15%。",
      "20÷15×100≈133%。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "南25加北20，25+20=45%。50多加了5；40少加5；55加了東區。合計占比只加題目指定的部分。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "南25%，北20%。",
      "25+20=45。",
      "合計45%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "麵30%，400×30%=120票。150是400×37.5%；200是400×50%；80是400×20%。換算時確認類別與占比對應正確。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "總票400，麵30%。",
      "400×0.3=120。",
      "麵類120票。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "甲35減乙25，35−25=10個百分點。35是甲占比本身；25是乙占比；60是35+25。百分點差就是兩占比相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "甲35%，乙25%。",
      "35−25=10。",
      "多10個百分點。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "夏25%對應120人，120÷0.25=480人。400是120÷0.3；600是120÷0.2；360計算錯。已知部分占比與人數，總數=部分÷占比。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "夏25%是120人。",
      "120÷0.25=480。",
      "全部約480人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "A占50%、C占20%，50−20=30個百分點。錯選20是把C占比當差值，50是A占比本身，70則把A、C占比相加而不是相減。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "A50%，C20%。",
      "50−20=30。",
      "少30個百分點。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "支持60%不到70%，說超過七成不實。60%是多數且過半，但題目用「超過七成」需達70%以上。文字用語要對照百分比數值。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "支持占60%。",
      "60%小於70%。",
      "「超過七成」不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "加總150+155+160+158+162=785，785÷5=157cm。155只取中間值；160是某一個值；158是另一個值。平均要先加總再除以個數5。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "五數加總785。",
      "除以5人。",
      "平均157cm。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "加總30+45+40+50=165，165÷4=41.25分鐘。40只取某一值；42、43計算錯。平均數=總和÷天數，不能挑其中幾天估算。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "四天加總165分鐘。",
      "除以4天。",
      "平均41.25分鐘。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "三數和12×3=36，36−10−14=12。10、14是已知兩數本身；16是36−20誤算。已知平均反推：總和=平均×個數，再減已知部分。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "三數和12×3=36。",
      "36−10−14=12。",
      "第三數12。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "總分=平均×人數，80×30=2400分。800是80×10；240是80×3；2000少乘了。平均80乘30人得2400分，不能用錯誤的個數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "平均80分，30人。",
      "80×30=2400。",
      "總分2400。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五數和12×5=60，60−8−10−12−14=16。14是已知數之一；12是平均本身；18計算錯。反推未知數：總和減已知四數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "五數和12×5=60。",
      "減去8、10、12、14得16。",
      "x=16。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總額=2500×4=10000元。2500是平均不是總額；7500是2500×3；5000是2500×2。平均乘天數得總額。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "平均2500元，4天。",
      "2500×4=10000。",
      "共10000元。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總和=15×6=90。15是平均本身；75是15×5；60是15×4。總和=平均×個數，個數是6。列式要用題目全部已知數字再作答，不能跳步。結論必須依題目所給資料計算得到。",
    "steps": [
      "平均15，6個數。",
      "15×6=90。",
      "總和90。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "男生總1650、女生總2400，合4050，25人，4050÷25=162cm。165只取男生；160只取女生；163計算錯。分組平均要用各組總和相加再除以總人數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "男生1650，女生2400。",
      "合4050，25人。",
      "全班平均162cm。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "原四數和72，加22得94，5個數，94÷5=18.8。20是(18+22)÷2；19計算錯；18忽略新數。加入新資料要重算總和再除以新個數。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "原四數和18×4=72。",
      "加22得94，5個數。",
      "新平均18.8。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最低70去掉，剩80+85+90+75=330，4次，330÷4=82.5。80只取一個；85、83計算錯。去掉極值後要重算剩餘資料的平均。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "去掉最低70。",
      "剩330分，4次。",
      "新平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "設原n人，75n+80=76(n+1)，解得n=4。錯選5、3、6代入平均公式都不成立，只有n=4時新平均才是76分。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "設原n人，75n+80=76(n+1)。",
      "解得n=4。",
      "原4人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "8人70分，中位70較代表多數。平均74被95拉高；全距只表分散；眾數95只有2人。選代表要看一般水準而非少數高分。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "8人70分，2人95分。",
      "中位70代表多數。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "2到3件差1件，50%比例誇大，絕對量仍小。確實增加但幅度小；平均不適用；眾數無關。50%看起來很大，但只從2件增到3件，絕對量仍很小。",
    "steps": [
      "2件到3件。",
      "基數小比例誇大。",
      "配合絕對量解讀。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "5人樣本太小，60%可能是3人支持，應擴大樣本。立刻加課太草率；平均中位不適用此調查。決策前樣本要足夠。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "只問5人。",
      "樣本太小。",
      "應擴大樣本再決定。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200則評論比10則可靠，A店較可信。B樣本小易受個別影響；平均相同；樣本大通常較穩定。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "A有200則，B有10則。",
      "樣本大較可靠。",
      "A店較可信。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "中位70代表中間水準，不受95影響。平均73被95拉高；全距只表分散；無眾數。有極端高分時中位較適合報一般水準。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "有95極端高分。",
      "中位70較穩。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "下午5人最多，眾數是下午。上午4人次之；晚上3人；平均不適用類別偏好。類別資料用眾數找最多偏好。列式要用題目全部已知數字再作答，不能跳步。",
    "steps": [
      "下午5人最多。",
      "上午4、晚上3。",
      "下午較適合。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "前四次穩定上升50到65，90可能是偶然，目標70左右較務實。90是單次最高；85仍偏高；50太低。前四次在50到65之間，單次90可能是偶然高分。",
    "steps": [
      "前四次50到65。",
      "90可能是偶然。",
      "目標70左右較務實。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "閱讀統計報告時，要先確認資料來源與樣本是否可靠，而不是被圖形顏色、數字大小或頁數多寡誤導。「資料來源與樣本是否可靠」才是最優先檢查的項目。",
    "steps": [
      "先看來源與樣本。",
      "是否可靠。",
      "最優先。"
