window.MATH_QUESTION_BANK_V2_U09 = [
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "45 公斤以上含 45−49、50−54、55−59 三組，10+8+4=22 人。18 漏加 55−59；24 多加了 40−44；14 只算 45−49。「以上」要把 45−49 起算的三組全部加總。45公斤以上含45−49、50−54、55−59三組，10+8+4=22人。18漏加55−59；24多加了40−44；14只算45−49。「以上」要把45−49起算的三組次數全部加總，不能漏組也不能多算40−44。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "至少 1 次不含 0 次，35+25+10+5=75 人。95 把 0 次也加進去；55 漏加 10 次或 5 次；70 則加總不完整。至少1次不含0次，35+25+10+5=75人。95把0次也加進去；55漏加10次或5次；70計算不完整。",
    "steps": [
      "至少1次不含0次組。",
      "35+25+10+5=75。",
      "共75人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "70 分以下不含 70−79，只含 50−59 與 60−69，2+5=7 人。5 只算 60−69；10 誤含 70−79；2 只算 50−59。「以下」不含 70−79 這一組。70分以下不含70−79，只含50−59與60−69，2+5=7人。5只算60−69；10誤含70−79；2只算50−59。「以下」不含70−79這一組，只能加50−59與60−69兩組。",
    "steps": [
      "70以下不含70−79。",
      "2+5=7人。",
      "共7人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "21 以上含 21−30 與 31−40，14+8=22 人。18 漏加 31−40；26 誤含 11−20；14 只算 21−30。21以上含21−30與31−40，14+8=22人。18漏加31−40；26誤含11−20；14只算21−30。讀表時要確認邊界組別是否納入，以上通常含該起點組別。",
    "steps": [
      "21以上含21−30、31−40。",
      "14+8=22。",
      "共22人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200 以下不含 200−299，只含 100 以下與 100−199，8+15=23 人。35 把 200−299 也加進去；40 多加了 300 以上。200以下不含200−299，只含100以下與100−199，8+15=23人。35把200−299也加進去；40多加了300以上；27計算不完整。",
    "steps": [
      "200以下不含200−299組。",
      "8+15=23。",
      "共23人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7 或以上含 7、8、9 以上，12+10+3=25 人。22 漏加 9 以上；30 誤含 6；15 只算 7 這一組。7或以上含7、8、9以上，12+10+3=25人。22漏加9以上；30誤含6；15只算7。讀表時「或以上」要把起點組與更高組別全部加總。",
    "steps": [
      "7或以上含7、8、9以上。",
      "12+10+3=25。",
      "共25人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "三班 40+55+35=130 人。120 漏加 C 班 35 人；140 多加了 10 人；125 則加總不完整。三班相加40+55+35=130人。120漏加C班；140多加了10人；125計算不完整。長條圖文字資料求總量要把各類別數字全部加總。",
    "steps": [
      "讀出A40、B55、C35。",
      "三數相加。",
      "合計130人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週一 120 件、週二 95 件，120−95=25 件。15 像 110−95；30 像 120−90；20 則不是這兩天相減。週一120、週二95，120−95=25件。15是110−95；30是120−90；20計算錯誤。比較兩類別用大數減小數，要鎖定題目指定的兩天。",
    "steps": [
      "週一120件，週二95件。",
      "120−95=25。",
      "多25件。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三月 22 萬、二月 18 萬，22−18=4 萬。3、5、2 都不是 22 與 18 相減；題目指定這兩個月。三月22萬減二月18萬，22−18=4萬。3、5、2都不是22與18相減的結果。題目指定二月到三月，要用這兩個月份的銷售額相減。",
    "steps": [
      "二月18萬，三月22萬。",
      "22−18=4。",
      "成長4萬。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四社 30+25+20+15=90 人。75 漏加桌球社 15 人；85 少加 15；70 只加前三社。四社相加30+25+20+15=90人。75漏加桌球社；85少加15；70只加前三社。文字長條圖求總量要把題目列出的各類全部加總。",
    "steps": [
      "四社人數30、25、20、15。",
      "全部相加。",
      "共90人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "數學 92 分、英文 78 分，92−78=14 分。10、12、16 都不是 92 與 78 的差。數學92分、英文78分，題目問數學比英文高幾分，所以92−78=14。10、12、16都不是92與78的差；兩科分數直接相減即可。",
    "steps": [
      "數學92分，英文78分。",
      "92−78=14。",
      "高14分。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "四區總人 340，南部 95 人，95÷340×100≈28%。26 像 95÷365；30 把 95 當分母；25 是計算錯。總人120+85+95+40=340，南部95，95÷340×100≈27.9%，約28%。26是95÷365誤算；30把95當分母；25計算錯。百分比分母必須是四區人數總和340。",
    "steps": [
      "總人340人。",
      "南部95人。",
      "95÷340×100≈28%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四個月 840 元，840÷4=210 元。200 只算一月；220 只算四月；215 是除法算錯。四個月200+240+180+220=840，840÷4=210元。200只算一月、220只算四月，215是計算錯誤。平均每月要把四個月支出全部相加再除以4。",
    "steps": [
      "四個月加總840元。",
      "除以4個月。",
      "平均210元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "紅茶 60 杯、奶茶 55 杯，60−55=5 杯。10 像 60−50；15 像 55−40；20 則不是這兩類相減。紅茶60、奶茶55，60−55=5杯。10是60−50；15是55−40；20計算錯。誰多誰少要看數值大小，紅茶較多，用紅茶減奶茶。",
    "steps": [
      "紅茶60杯，奶茶55杯。",
      "60−55=5。",
      "奶茶少5杯。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三店平均 (300+250+280)÷3≈276.7 元，不到 290 元。甲店 300 雖超過 290，但題目問的是三店平均，不是單店最高。三店平均(300+250+280)÷3=830÷3≈276.7元，不到290。甲店300超過290但平均不是看單一最高；中位也不是判斷平均的標準。",
    "steps": [
      "三店加總830元。",
      "830÷3≈277元。",
      "不到290，說法不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五個數 12、15、18、20、25 已由小到大排列，正中央第 3 個是 18。15 只是第 2 個數、20 是第 4 個數；17 則像把全部數直接平均，不是中位數。五個數12、15、18、20、25排序後，正中央第3個是18。",
    "steps": [
      "由小到大：12、15、18、20、25。",
      "第3個是18。",
      "中位數18。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "四個數8、10、12、14 已排好，因為資料有偶數個，所以要取中間兩數 10 與 12 的平均，得到 11。10 或 12 都只取了其中一個中間數；13 則不是由 10 與 12 平均得到。",
    "steps": [
      "排序8、10、12、14。",
      "中間兩數10、12。",
      "平均11。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "先把 5、3、8、6、4 排成 3、4、5、6、8，奇數個資料正中央第 3 個是中位數 5。4 是第 2 個、6 是第 4 個；8 是最大值，不能當中位數。先排序3、4、5、6、8，正中央第3個是5。4是第2個；6是第4個；8是最大值不是中位。",
    "steps": [
      "排序3、4、5、6、8。",
      "第3個是5。",
      "中位數5。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "六人分數排成 70、75、80、85、90、95，偶數個資料要取中間兩數 80 與 85 的平均，(80+85)÷2=82.5。80 或 85 只取其中一個；77.5 則像用錯位置的兩數平均。排序70、75、80、85、90、95，中間兩數80與85，(80+85)÷2=82.5。",
    "steps": [
      "排序70、75、80、85、90、95。",
      "中間80、85。",
      "平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五個 2 全部相同，排序後正中央仍是 2，中位數就是 2。0、10、4 都不在這組資料中，不能拿來當中位數。五個2全部相同，排序後中間仍是2。",
    "steps": [
      "五個都是2。",
      "排序後中間是2。",
      "中位數2。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "七個數 10、20、30、40、50、60、70 已排序，奇數個取第 (7+1)÷2=4 個，也就是 40。30 是第 3 個、50 是第 5 個；35 則像把 30 與 40 平均，但七個數不需這樣算。已排序，第4個40是中位數。",
    "steps": [
      "七數已排序。",
      "第4個是40。",
      "中位數40。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "原四數 15、25、35、45 的中位是 (25+35)÷2=30；加入 50 後排成 15、25、35、45、50，正中央第 3 個變 35。30 是加入前的中位；40、45 都不是新的正中央。原四數中位(25+35)÷2=30，加入50後排序15、25、35、45、50，正中央35。",
    "steps": [
      "加入50後排序。",
      "五數正中央35。",
      "新中位數35。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "身高 155、160、165、168、170 已排序，五人奇數個，正中央第 3 個是 165。160 是第 2 個、168 是第 4 個；166.5 像把 160 與 168 平均，不是本題中位。排序155、160、165、168、170，正中央165。160是第2個；168是第4個；166.5是錯誤平均。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "八個數 3、7、11、15、19、23、27、31 已排序，偶數個取第 4、5 兩數 15 與 19 平均，(15+19)÷2=17。15 或 19 只取單一個；16 則不是 15 與 19 的平均。八個數已排序，第4個15與第5個19，(15+19)÷2=17。15、19是單個數；16是錯位平均。",
    "steps": [
      "中間兩數15、19。",
      "(15+19)÷2=17。",
      "中位數17。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "100、200、300、400、500、600 成等差數列，中位是 (300+400)÷2=350，平均也是 (100+600)×6÷2÷6=350，兩者相同。若只算 300 或 400 其中一個，就不能代表中位。平均(100+200+300+400+500+600)÷6=350，中位(300+400)÷2=350，相同。這組等差資料中位與平均相同。",
    "steps": [
      "平均350。",
      "中位(300+400)÷2=350。",
      "兩者相同。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "3、5、5、7、9 中，5 出現 2 次最多，眾數是 5。3、7、9 各只出現 1 次，次數較少，不能當眾數。5出現2次最多，眾數是5。3、7、9各出現1次。眾數是出現次數最多的數值，可能不唯一但本題5唯一最多。",
    "steps": [
      "數出各數次數。",
      "5出現2次最多。",
      "眾數5。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "五次分數 10、15、20、25、30 中，最大 30、最小 10，全距 30−10=20。15 像 20−5 亂減、25 像 30−5；10 則是最小值本身，不是全距。最大30、最小10，30−10=20。15是20−5；25是30−5；10是最小值本身。全距用最大減最小，不能把最小值本身當全距。",
    "steps": [
      "最大30，最小10。",
      "30−10=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "2、4、4、6、4、8 中，4 出現 3 次最多，眾數是 4。2、6、8 次數較少；6 雖在中间位置，但不是出現最多次的數。4出現3次最多，眾數是4。2、6、8次數較少。眾數可能與其他指標不同，要找出現最多次的數。",
    "steps": [
      "4出現3次。",
      "其他次數較少。",
      "眾數4。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "分數 12、18、15、22、9 中，最大 22、最小 9，全距 22−9=13。10、15、7 都不是 22 與 9 相減的結果。全距就是這五個分數的最大減最小。最大22、最小9，22−9=13。10、15、7不是22與9相減。全距是這五個分數中最大減最小。",
    "steps": [
      "最大22，最小9。",
      "22−9=13。",
      "全距13。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "尺碼 5、5、8、8、10 中，5 和 8 都出現 2 次，同為眾數，所以有 2 個眾數。10 只出現 1 次；1 個或 3 個都不符合實際次數。5和8各出現2次同為最多，有2個眾數。",
    "steps": [
      "5出現2次，8出現2次。",
      "同為最多。",
      "有2個眾數。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "100、105、110、115、120 中，最大 120、最小 100，全距 120−100=20。15、10、25 都不是最大減最小的結果。等差數列仍用最大減最小。最大120、最小100，120−100=20。15、10、25不是120與100相減。等差數列的全距仍用最大減最小。",
    "steps": [
      "最大120，最小100。",
      "120−100=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7、3、7、5、7、9 中，7 出現 3 次最多，眾數是 7。3、5、9 各只出現 1 次，不能當眾數。7出現3次最多，眾數是7。3、5、9各1次。眾數不受排列順序影響，但要數清楚次數。",
    "steps": [
      "7出現3次。",
      "其他各1次。",
      "眾數7。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "45、52、38、61、55 中，最大 61、最小 38，全距 61−38=23。17、20、15 都不是 61 與 38 相減。全距反映這五筆分數從最小值到最大值的差距。最大61、最小38，61−38=23。17、20、15不是61與38相減。全距反映這五筆資料的散布範圍。",
    "steps": [
      "最大61，最小38。",
      "61−38=23。",
      "全距23。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "六個數 1、2、3、4、5 各出現 1 次，沒有出現最多次的數，所以無眾數。3 是中位數不是眾數；1、5 只是資料端點。各數都只出現1次，沒有出現最多次的數，無眾數。",
    "steps": [
      "各數都只出現1次。",
      "沒有最多。",
      "無眾數。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "20、25、30、35、40 中，最大 40、最小 20，全距 40−20=20。0 像把全距與平均混談；10 是 30−20、5 是 25−20，都不是全距。最大40、最小20，40−20=20。0把全距當成平均與全距的差；10是30−20；5是25−20。本題問全距，用最大減最小得20，不要與平均數混淆。",
    "steps": [
      "最大40，最小20。",
      "40−20=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "鞋號 36、37、37、38、39、37 中，37 出現 3 次最多，眾數是 37；最大 39、最小 36，全距 39−36=3。36 是最小值不是眾數；全距 4 則把 36 誤當 35。37出現3次最多，眾數37；最大39最小36，全距3。36是最小不是眾數；38出現1次；全距4把36當35。",
    "steps": [
      "37出現3次最多。",
      "最大39最小36。",
      "眾數37，全距3。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "加權和 80×2+90×3+70×1=500，權重和 6，500÷6≈83.33。80 是三科簡單平均；85、82 則加權計算錯誤。加權和80×2+90×3+70×1=160+270+70=500，權重和2+3+1=6，500÷6≈83.33。80是簡單平均；85、82計算錯。各項分數乘權重相加後，再除以權重總和2+3+1。",
    "steps": [
      "加權和500。",
      "權重和6。",
      "500÷6≈83.33。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "A 班 20 人共 1500、B 班 30 人共 2550，合 4050 分、50 人，4050÷50=81。80 是 (75+85)÷2 誤把兩班平均直接平均；82、79 是計算錯。A班20人總1500、B班30人總2550，合4050，50人，4050÷50=81。80是(75+85)÷2誤算；82、79是計算錯誤。兩班總分相加再除以50人。",
    "steps": [
      "A總1500，B總2550。",
      "合4050，50人。",
      "平均81。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總價 2×50+3×40=220 元，總重 5 公斤，220÷5=44 元/公斤。45 是 (50+40)÷2 誤算；46、42 是計算錯。混合單價要用總價除以總重量。總價2×50+3×40=220，總重5公斤，220÷5=44元。45是(50+40)÷2誤算；46、42是計算錯誤。",
    "steps": [
      "總價220元。",
      "總重5公斤。",
      "平均44元/公斤。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "80×30%+90×50%+70×20%=24+45+14=83 分。84、85 是乘法或加總錯誤；82 則少加態度這一項。三項分別乘 30%、50%、20% 後相加。80×0.3+90×0.5+70×0.2=24+45+14=83分。84、85是計算錯誤；82少加態度項。三項分數分別乘30%、50%、20%後相加。",
    "steps": [
      "24+45+14=83。",
      "權重和100%。",
      "總評83分。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "上午 5000、下午 12000，合 17000 元、300 件，17000÷300≈56.67 元。55 是 (50+60)÷2 誤算；57、58 是計算錯。全天平均要用總銷售額除以總件數。上午5000、下午12000，合17000，300件，17000÷300≈56.67元。55是(50+60)÷2誤算；57、58是計算錯誤。",
    "steps": [
      "上午5000，下午12000。",
      "合17000，300件。",
      "平均≈56.67元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "男 2550、女 4000，合 6550cm、40 人，6550÷40=163.75cm。165 是 (170+160)÷2 誤算；162、164 是計算錯。全班平均要用兩性總身高除以 40 人。男總2550、女總4000，合6550，40人，6550÷40=163.75cm。165是(170+160)÷2誤算；162、164是計算錯誤。全班平均=兩性總身高除以40人。",
    "steps": [
      "男2550，女4000。",
      "合6550，40人。",
      "平均163.75cm。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "三種肥料總價 20+24+12=56 元、6 包，56÷6≈9.33 元/包。10 只算甲包單價；9、8.67 是計算錯。總價20+24+12=56，6包，56÷6≈9.33元。10只算甲包；9、8.67是計算錯誤。平均每包=三種肥料總價56除以6包。",
    "steps": [
      "總價56元。",
      "6包。",
      "平均≈9.33元/包。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "甲組 280、乙組 480，合 760 分、10 人，760÷10=76。75 是 (70+80)÷2 誤算；77、74 是計算錯。合計平均要用兩組總分除以 10 人。甲總280、乙總480，合760，10人，760÷10=76。75是(70+80)÷2誤算；77、74是計算錯誤。合計平均=兩組總分除以10人。",
    "steps": [
      "甲280，乙480。",
      "合760，10人。",
      "平均76。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "85×20%+90×50%+80×30%=17+45+24=86 分。85 像漏加某一項；87、84 是計算錯。平時、段考、期末要分別乘 20%、50%、30% 後相加。85×0.2+90×0.5+80×0.3=17+45+24=86。85漏加某項；87、84是計算錯誤。平時、段考、期末分別乘20%、50%、30%後相加。",
    "steps": [
      "17+45+24=86。",
      "占比和100%。",
      "總成績86。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "花生 600 元加杏仁 1000 元，總價 1600 元、500g，1600÷500=3.2 元/g。3.5 是 (2+5)÷2 誤算；3、2.8 是計算錯。混合平均單價要用總價除以總重量。總價600+1000=1600，500g，1600÷500=3.2元。3.5是(2+5)÷2誤算；3、2.8是計算錯誤。混合堅果平均單價=總價1600除以500g。",
    "steps": [
      "總價1600元。",
      "總重500g。",
      "平均3.2元/g。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "加權總和 85×6=510，國文 80×2+數學 90×3=430，英文 510−430=80。85 是加權平均本身；82、78 是反推錯誤。加權和85×6=510，已用80×2+90×3=430，英文510−430=80。85是平均本身；82、78計算錯。反推未知項：加權總和減已知加權部分。",
    "steps": [
      "加權和510。",
      "已用430。",
      "英文80。"
