window.MATH_QUESTION_BANK_V2_U09 = [
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "45以上含45−49、50−54、55−59三組，10+8+4=22人。18漏加55−59；24多加了40−44；14只算45−49。讀表時要確認「以上」包含哪些組別。須依邊界用語決定要加哪些組別。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "至少1次不含0次，35+25+10+5=75人。95把0次也加進去；55漏加10次或5次；70計算不完整。次數表求「至少」要排除指定組別。須依邊界用語決定要加哪些組別。",
    "steps": [
      "至少1次不含0次組。",
      "35+25+10+5=75。",
      "共75人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "70以下不含70−79，只含50−59與60−69，2+5=7人。5只算60−69；10誤含70−79；2只算50−59。邊界要分清「以下」是否含該分數。須依邊界用語決定要加哪些組別。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "70以下不含70−79。",
      "2+5=7人。",
      "共7人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "21以上含21−30與31−40，14+8=22人。18漏加31−40；26誤含11−20；14只算21−30。讀表時要確認邊界組別是否納入，以上通常含該起點組別。須依邊界用語決定要加哪些組別。",
    "steps": [
      "21以上含21−30、31−40。",
      "14+8=22。",
      "共22人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200以下不含200−299，只含100以下與100−199，8+15=23人。35把200−299也加進去；40多加了300以上；27計算不完整。邊界用語決定要加哪些組別。須依邊界用語決定要加哪些組別。",
    "steps": [
      "200以下不含200−299組。",
      "8+15=23。",
      "共23人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7或以上含7、8、9以上，12+10+3=25人。22漏加9以上；30誤含6；15只算7。讀表時「或以上」要把起點組與更高組別全部加總。須依邊界用語決定要加哪些組別。",
    "steps": [
      "7或以上含7、8、9以上。",
      "12+10+3=25。",
      "共25人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "三班相加40+55+35=130人。120漏加C班；140多加了10人；125計算不完整。長條圖文字資料求總量要把各類別數字全部加總。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "讀出A40、B55、C35。",
      "三數相加。",
      "合計130人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週一120、週二95，120−95=25件。15是110−95；30是120−90；20計算錯誤。比較兩類別用大數減小數，要鎖定題目指定的兩天。鎖定題幹指定的兩類或兩期再相減。",
    "steps": [
      "週一120件，週二95件。",
      "120−95=25。",
      "多25件。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三月22減二月18，22−18=4萬。3是20−17之類；5是22−17；2是18−16。成長量用後期減前期，單位仍為萬元。鎖定題幹指定的兩類或兩期再相減。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "二月18萬，三月22萬。",
      "22−18=4。",
      "成長4萬。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四社相加30+25+20+15=90人。75漏加桌球社；85少加15；70只加前三社。文字長條圖求總量要把題目列出的各類全部加總。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "四社人數30、25、20、15。",
      "全部相加。",
      "共90人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "數學92、英文78，92−78=14分。10是92−82；12是88−78；16是92−76。比較兩科分數直接相減，不必再除以人數。答案須直接由題幹數字依統計量定義計算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "數學92分，英文78分。",
      "92−78=14。",
      "高14分。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "總人120+85+95+40=340，南部95，95÷340×100≈27.9%，約28%。26是95÷365誤算；30把95當分母；25計算錯。百分比分母必須是四區人數總和340。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "總人340人。",
      "南部95人。",
      "95÷340×100≈28%。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "四個月200+240+180+220=840，840÷4=210元。200只取1月；220只取4月；215計算錯。平均要先加總再除以月份數。全部資料加總後再除以個數。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "四個月加總840元。",
      "除以4個月。",
      "平均210元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "紅茶60、奶茶55，60−55=5杯。10是60−50；15是55−40；20計算錯。誰多誰少要看數值大小，紅茶較多，用紅茶減奶茶。鎖定題幹指定的兩類或兩期再相減。",
    "steps": [
      "紅茶60杯，奶茶55杯。",
      "60−55=5。",
      "奶茶少5杯。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "三店平均(300+250+280)÷3=830÷3≈276.7元，不到290。甲店300超過290但平均不是看單一最高；中位也不是判斷平均的標準。文字結論要配合計算。全部資料加總後再除以個數。",
    "steps": [
      "三店加總830元。",
      "830÷3≈277元。",
      "不到290，說法不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "3月15、1月10，15−10=5度。3是12−10只比2月；2是13−11；4是14−10。用後期減前期看正負，並鎖定指定月份。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "3月15度，1月10度。",
      "15−10=5。",
      "高5度。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "週三48減週二55，48−55=−7件，減少7件。7是55−48方向反；3是52−49；−3計算錯。相鄰變化用後期減前期，負號表示下降。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "週二55，週三48。",
      "48−55=−7。",
      "減少7件。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較20、35、42、38，42最大，10時最多。8時35次之；12時38；6時20最少。折線圖找最高點要比較全部時點數值。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "讀出20、35、42、38。",
      "42最大。",
      "10時人數最多。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "4月260減1月200，260−200=60元。40是220−200只到2月；80是260−180；50計算錯。期間總變化用終點減起點，不是逐段相加。用後期減前期看正負，並鎖定指定月份。",
    "steps": [
      "1月200，4月260。",
      "260−200=60。",
      "共增加60元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最高95、最低88，95−88=7分。5是92−87；8是95−87；4是90−86。折線圖全距式差量要先找最大最小再相減。答案須直接由題幹數字依統計量定義計算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "最高95，最低88。",
      "95−88=7。",
      "差7分。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "比較10時45人與12時50人，50−45=5人。10是50−40；3是45−42；8計算錯。相鄰時點比較直接相減，要鎖定題目指定的兩個時間。用後期減前期看正負，並鎖定指定月份。",
    "steps": [
      "12時50人，10時45人。",
      "50−45=5。",
      "多5人。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "2月120、3月110，110−120=−10，3月少10。多10方向反；一樣明顯不對；少5計算錯。折線圖判斷升降用後期減前期看正負。用後期減前期看正負，並鎖定指定月份。",
    "steps": [
      "2月120，3月110。",
      "110−120=−10。",
      "3月少10。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "蘋果40%減香蕉30%，40−30=10個百分點。30是香蕉占比；40是蘋果占比本身；70是40+30相加。相關部分占比相加或單獨讀取，須對準類別。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "蘋果40%，香蕉30%。",
      "40−30=10。",
      "多10個百分點。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "圓形圖直接讀單車35%。25是步行；30是公車；65是35+30誤加。各部分占比已在文字中給出，直接對應類別即可。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "找單車對應百分比。",
      "單車35%。",
      "占35%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "國文30加英文25，30+25=55%。50漏加5；45只算國文加自然；60多加5。圓形圖求合計占比把相關部分百分比相加。相關部分占比相加或單獨讀取，須對準類別。",
    "steps": [
      "國文30%，英文25%。",
      "30+25=55。",
      "合計55%。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "A占45%，200×45%=200×0.45=90人。80是200×40%；100是200×50%；45把百分比當人數。百分比換算人數用總數乘占比。用總人數或總票數乘該類占比換算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "總數200人，A占45%。",
      "200×0.45=90。",
      "A有90人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "藍35、綠15，差20，以綠15為基準，20÷15×100≈133%。20是百分點差不是增加率；35是藍占比；15是綠占比。增加率基準要清楚。相關部分占比相加或單獨讀取，須對準類別。",
    "steps": [
      "藍35%，綠15%，差20。",
      "基準綠15%。",
      "20÷15×100≈133%。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "南25加北20，25+20=45%。50多加了5；40少加5；55加了東區。合計占比只加題目指定的部分。答案須直接由題幹數字依統計量定義計算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "南25%，北20%。",
      "25+20=45。",
      "合計45%。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "麵30%，400×30%=120票。150是400×37.5%；200是400×50%；80是400×20%。換算時確認類別與占比對應正確。答案須直接由題幹數字依統計量定義計算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "總票400，麵30%。",
      "400×0.3=120。",
      "麵類120票。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "夏25%對應120人，120÷0.25=480人。400是120÷0.3；600是120÷0.2；360計算錯。已知部分占比與人數，總數=部分÷占比。用總人數或總票數乘該類占比換算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "夏25%是120人。",
      "120÷0.25=480。",
      "全部約480人。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "支持60%不到70%，說超過七成不實。60%是多數且過半，但題目用「超過七成」需達70%以上。文字用語要對照百分比數值。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "支持占60%。",
      "60%小於70%。",
      "「超過七成」不成立。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "加總150+155+160+158+162=785，785÷5=157cm。155只取中間值；160是某一個值；158是另一個值。平均要先加總再除以個數5。全部資料加總後除以個數，不能挑部分估算。",
    "steps": [
      "五數加總785。",
      "除以5人。",
      "平均157cm。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "加總30+45+40+50=165，165÷4=41.25分鐘。40只取某一值；42、43計算錯。平均數=總和÷天數，不能挑其中幾天估算。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "四天加總165分鐘。",
      "除以4天。",
      "平均41.25分鐘。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "三數和12×3=36，36−10−14=12。10、14是已知兩數本身；16是36−20誤算。已知平均反推：總和=平均×個數，再減已知部分。全部資料加總後除以個數，不能挑部分估算。",
    "steps": [
      "三數和12×3=36。",
      "36−10−14=12。",
      "第三數12。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "總分=平均×人數，80×30=2400分。800是80×10；240是80×3；2000少乘了。總量等於平均乘個數，不能把平均當總和。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "平均80分，30人。",
      "80×30=2400。",
      "總分2400。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五數和12×5=60，60−8−10−12−14=16。14是已知數之一；12是平均本身；18計算錯。反推未知數：總和減已知四數。答案須直接由題幹數字依統計量定義計算。",
    "steps": [
      "五數和12×5=60。",
      "減去8、10、12、14得16。",
      "x=16。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總額=2500×4=10000元。2500是平均不是總額；7500是2500×3；5000是2500×2。平均乘天數得總額。全部資料加總後除以個數，不能挑部分估算。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "平均2500元，4天。",
      "2500×4=10000。",
      "共10000元。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總和=15×6=90。15是平均本身；75是15×5；60是15×4。總和=平均×個數，個數是6。總量等於平均乘個數，不能把平均當總和。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "平均15，6個數。",
      "15×6=90。",
      "總和90。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "男生總1650、女生總2400，合4050，25人，4050÷25=162cm。165只取男生；160只取女生；163計算錯。分組平均要用各組總和相加再除以總人數。分組平均要用各組總分相加再除以總人數。",
    "steps": [
      "男生1650，女生2400。",
      "合4050，25人。",
      "全班平均162cm。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "原四數和72，加22得94，5個數，94÷5=18.8。20是(18+22)÷2；19計算錯；18忽略新數。加入新資料要重算總和再除以新個數。加入新資料後總和與個數都要更新再除。",
    "steps": [
      "原四數和18×4=72。",
      "加22得94，5個數。",
      "新平均18.8。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最低70去掉，剩80+85+90+75=330，4次，330÷4=82.5。80只取一個；85、83計算錯。去掉極值後要重算剩餘資料的平均。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "去掉最低70。",
      "剩330分，4次。",
      "新平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "設原n人，75n+80=76(n+1)，解得n=4。錯選5、3、6代入平均公式都不成立，只有n=4時新平均才是76分。用平均列方程，把加入前後總分寫成等式。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "設原n人，75n+80=76(n+1)。",
      "解得n=4。",
      "原4人。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "五個數排序後中間是第3個18。15是第2個；20是第4個；17是15與19平均但資料無19。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "由小到大：12、15、18、20、25。",
      "第3個是18。",
      "中位數18。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "四個數偶數個，中間兩數10與12，(10+12)÷2=11。10是第2個；12是第3個；13計算錯。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "排序8、10、12、14。",
      "中間兩數10、12。",
      "平均11。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "先排序3、4、5、6、8，正中央第3個5。4是第2個；6是第4個；8是最大。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "排序3、4、5、6、8。",
      "第3個是5。",
      "中位數5。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "排序70、75、80、85、90、95，中間兩數80與85，(80+85)÷2=82.5。80、85是單個中間數；77.5是75與80平均錯位。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "排序70、75、80、85、90、95。",
      "中間80、85。",
      "平均82.5。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "全部相同，排序後中間仍是2。0、10、4都不在資料中。全部相同時中位數等於該數值。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "五個都是2。",
      "排序後中間是2。",
      "中位數2。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "已排序，第4個40是中位數。30是第3個；50是第5個；35是30與40平均但奇數個不需平均。七個數取第(7+1)÷2=4個。中位數須先排序再取中間位置。",
    "steps": [
      "七數已排序。",
      "第4個是40。",
      "中位數40。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "原四數中位(25+35)÷2=30，加入50後排序15、25、35、45、50，正中央35。30是加入前；40、32.5計算錯。資料變動要重新排序找中位。資料變動後要重新排序再找中位。",
    "steps": [
      "加入50後排序。",
      "五數正中央35。",
      "新中位數35。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "排序155、160、165、168、170，正中央165。160是第2個；168是第4個；166.5是165與168平均但奇數個取正中央。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "已排序，中間兩數第4個15與第5個19，(15+19)÷2=17。15、19是單個；16是15與17平均錯位。八個數取第4、5個平均。中位數須先排序再取中間位置。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "中間兩數15、19。",
      "(15+19)÷2=17。",
      "中位數17。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "平均(100+200+300+400+500+600)÷6=350，中位(300+400)÷2=350，相同。這組等差資料中位與平均相同。不能一般化，但本題可計算比較。這組資料可計算比較平均與中位，結果視資料而定。",
    "steps": [
      "平均350。",
      "中位(300+400)÷2=350。",
      "兩者相同。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "5出現2次最多，眾數是5。3、7、9各出現1次。眾數是出現次數最多的數值，可能不唯一但本題5唯一最多。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "數出各數次數。",
      "5出現2次最多。",
      "眾數5。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最大30、最小10，30−10=20。15是20−5；25是30−5；10是最小值本身。全距用最大減最小，不能把最小值本身當全距。全距是最大值減最小值，不能與平均數混淆。",
    "steps": [
      "最大30，最小10。",
      "30−10=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "4出現3次最多，眾數是4。2、6、8次數較少。眾數可能與其他指標不同，要找出現最多次的數。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "4出現3次。",
      "其他次數較少。",
      "眾數4。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "最大22、最小9，22−9=13。10是18−8；15是22−7；7是16−9。全距要先找最大最小再相減。全距是最大值減最小值，不能與平均數混淆。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "最大22，最小9。",
      "22−9=13。",
      "全距13。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "5和8各出現2次同為最多，有2個眾數。1忽略8；0表示沒有但本題有；3不存在第三眾數。資料可以有多個眾數。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "5出現2次，8出現2次。",
      "同為最多。",
      "有2個眾數。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最大120、最小100，120−100=20。15是105−90；10是110−100；25是125−100。等差資料全距仍用最大減最小。全距是最大值減最小值，不能與平均數混淆。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "最大120，最小100。",
      "120−100=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "7出現3次最多，眾數是7。3、5、9各1次。眾數不受排列順序影響，但要數清楚次數。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "7出現3次。",
      "其他各1次。",
      "眾數7。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "最大61、最小38，61−38=23。17是55−38；20是58−38；15是53−38。全距反映資料散布範圍。全距是最大值減最小值，不能與平均數混淆。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "最大61，最小38。",
      "61−38=23。",
      "全距23。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "各數都只出現1次，沒有出現最多次的數，無眾數。3是中位數不是眾數；1、5是端點。全部不同時可能沒有眾數。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "各數都只出現1次。",
      "沒有最多。",
      "無眾數。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "最大40、最小20，40−20=20。0把全距當成平均與全距的差；10是30−20；5是25−20。本題問全距，用最大減最小得20，不要與平均數混淆。全距是最大值減最小值，不能與平均數混淆。",
    "steps": [
      "最大40，最小20。",
      "40−20=20。",
      "全距20。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "37出現3次最多，眾數37；最大39最小36，全距3。36是最小不是眾數；38出現1次；全距4把36當35。眾數與全距要分別計算。須數各數出現次數，全部不同時可能沒有眾數。",
    "steps": [
      "37出現3次最多。",
      "最大39最小36。",
      "眾數37，全距3。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "加權和80×2+90×3+70×1=160+270+70=500，權重和2+3+1=6，500÷6≈83.33。80是簡單平均；85、82計算錯。各項分數乘權重相加後，再除以權重總和2+3+1。各項分數乘權重或占比後相加，再除以權重總和。",
    "steps": [
      "加權和500。",
      "權重和6。",
      "500÷6≈83.33。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "A總1500、B總2550，合4050，50人，4050÷50=81。80是(75+85)÷2；82、79計算錯。不同件數或人數的組別要用總額除以總量。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "A總1500，B總2550。",
      "合4050，50人。",
      "平均81。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總價2×50+3×40=100+120=220，總重5公斤，220÷5=44元。45是(50+40)÷2；46、42計算錯。混合平均用總價÷總量。混合平均用總價除以總重量，不能對單價直接平均。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "總價220元。",
      "總重5公斤。",
      "平均44元/公斤。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "80×0.3+90×0.5+70×0.2=24+45+14=83分。84、85計算錯；82少加態度項。百分比權重直接乘各項分數再相加，不必再除以100。加權平均須用總和除以權重或總量。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "24+45+14=83。",
      "權重和100%。",
      "總評83分。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "上午5000、下午12000，合17000，300件，17000÷300≈56.67元。55是(50+60)÷2；57、58計算錯。不同件數要用總額÷總件數。加權平均須用總和除以權重或總量。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "上午5000，下午12000。",
      "合17000，300件。",
      "平均≈56.67元。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "男總2550、女總4000，合6550，40人，6550÷40=163.75cm。165是(170+160)÷2；162、164計算錯。分組加權要用各組總和÷總人數。不同件數或人數的組別要用總額除以總量。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "男2550，女4000。",
      "合6550，40人。",
      "平均163.75cm。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "總價20+24+12=56，6包，56÷6≈9.33元。10只算甲；9、8.67計算錯。平均每包=總價÷總包數。混合平均用總價除以總重量，不能對單價直接平均。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "總價56元。",
      "6包。",
      "平均≈9.33元/包。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "甲總280、乙總480，合760，10人，760÷10=76。75是(70+80)÷2；77、74計算錯。不同人數的組別平均要用總分÷總人數。加權平均須用總和除以權重或總量。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "甲280，乙480。",
      "合760，10人。",
      "平均76。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "85×0.2+90×0.5+80×0.3=17+45+24=86。85漏加某項；87、84計算錯。占比權重各項分數相乘再相加。各項分數乘權重或占比後相加，再除以權重總和。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "17+45+24=86。",
      "占比和100%。",
      "總成績86。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "總價600+1000=1600，500g，1600÷500=3.2元。3.5是(2+5)÷2；3、2.8計算錯。混合平均用總價除以總重量，不能對單價直接平均。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "總價1600元。",
      "總重500g。",
      "平均3.2元/g。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "加權和85×6=510，已用80×2+90×3=430，英文510−430=80。85是平均本身；82、78計算錯。反推未知項：加權總和減已知加權部分。各項分數乘權重或占比後相加，再除以權重總和。",
    "steps": [
      "加權和510。",
      "已用430。",
      "英文80。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "8人70分，中位70較代表多數。平均74被95拉高；全距只表分散；眾數95只有2人。選代表要看一般水準而非少數高分。有極端值時中位較適合描述多數人的水準。",
    "steps": [
      "8人70分，2人95分。",
      "中位70代表多數。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "5人樣本太小，60%可能是3人支持，應擴大樣本。立刻加課太草率；平均中位不適用此調查。決策前樣本要足夠。樣本太小時不宜過度推論或立刻做決策。",
    "steps": [
      "只問5人。",
      "樣本太小。",
      "應擴大樣本再決定。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200則評論比10則可靠，A店較可信。B樣本小易受個別影響；平均相同；樣本大通常較穩定。樣本較大時平均或評價通常較穩定。",
    "steps": [
      "A有200則，B有10則。",
      "樣本大較可靠。",
      "A店較可信。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "中位70代表中間水準，不受95影響。平均73被95拉高；全距只表分散；無眾數。有極端高分時中位較適合報一般水準。有極端值時中位較適合描述多數人的水準。",
    "steps": [
      "有95極端高分。",
      "中位70較穩。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "下午5人最多，眾數是下午。上午4人次之；晚上3人；平均不適用類別偏好。類別資料用眾數找最多偏好。計算時要把題幹已列數字全部用進去，不能改用其他資料。",
    "steps": [
      "下午5人最多。",
      "上午4、晚上3。",
      "下午較適合。"
