window.MATH_QUESTION_BANK_V2_U05 = [
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "要檢查某點在不在給定直線上，應先把該點的 x、y 帶入方程式看等式是否成立，例如直線 x + y = 5，點 (2, 3) 代入得 2 + 3 = 5 成立即在線上。求斜率、截距是描圖用，不是判斷單點的第一步。",
    "steps": [
      "讀點的坐標。",
      "帶入直線方程式。",
      "檢查等式是否成立。"
  ...
  },
  {
    ...
    "concept": "兩直線交點：解聯立方程式；平行線（斜率同、截距不同）無交點；重合線無限多交點",
    "tags": [
      "坐標幾何",
