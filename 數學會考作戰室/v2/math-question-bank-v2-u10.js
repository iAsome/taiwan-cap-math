window.MATH_QUESTION_BANK_V2_U10 = [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「當 x = 2 時，3x + 1 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，代入 x = 2：3×2 + 1 = 6 + 1 = 7，得 7。5 可能是 2+3 順序錯；6 只算 3×2 忘加 1。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "把 x 換成 2。",
      "算 3×2 = 6。",
      "6 + 1 = 7。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「當 x = −1 時，x² + 2x 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，代入 x = −1：(−1)² + 2×(−1) = 1 − 2 = −1，得 −1。1 可能把 (−1)² 算成 −1；3 是符號全弄反。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x = −1 代入。",
      "(−1)² = 1，2x = −2。",
      "1 + (−2) = −1。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「當 a = 3、b = −2 時，2a − b 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，2×3 − (−2) = 6 + 2 = 8，減去負數要變加法，得 8。4 可能把 −b 當成減 2 得 4；0 是減號處理全錯。",
    "steps": [
      "a=3，b=−2 代入。",
      "2a = 6。",
      "6 − (−2) = 8。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "將題目給定的值代入代數式後依運算順序計算，代入 0 時先看哪些項會消失，得 4。x = 0 時，含 x 的項都是 0，只剩常數 4；0 是把整式都當 0。",
    "steps": [
      "x = 0 代入。",
      "5×0 與 −3×0 都是 0。",
      "整式值 = 4。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "將題目給定的值代入代數式後依運算順序計算，代入得 (3+1)(3−2) = 4×1 = 4，要先各自算括號內，再相乘，得 4。2 可能只算 x−2；6 可能只算 x+1 又加錯。",
    "steps": [
      "x = 3 代入。",
      "左括號 4，右括號 1。",
      "4 × 1 = 4。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「當 y = −2 時，y³ − y 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，(−2)³ − (−2) = −8 + 2 = −6，奇次方保留負號，減 y 要連括號，得 −6。6 是符號全反；−4 可能 y³ 算錯。",
    "steps": [
      "y = −2。",
      "(−2)³ = −8。",
      "−8 − (−2) = −6。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "將 x=1/2 代入 4x+3，先算 4×1/2=2，再加上 3 得 5。若得 4 通常是忘加常數 3，或把 4×(1/2) 誤算成 4；得 2 則只算了 4x 這一段，沒有把後面的 +3 一併完成，分數代入要先乘後加。",
    "steps": [
      "x = 1/2 代入。",
      "4 × 1/2 = 2。",
      "2 + 3 = 5。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「某商店每件 x 元，買 3 件再加手續費 10 元，總價代數式為 3x + 10。若 x = 50，總價多少元」而言，將題目給定的值代入代數式後依運算順序計算，3×50 + 10 = 150 + 10 = 160 元，得 160。150 是忘加手續費 10；60 可能 3+10 再乘。",
    "steps": [
      "總價 3x + 10。",
      "x = 50 代入。",
      "150 + 10 = 160。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「當 x = −3 時，2x² − x − 1 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，2×9 − (−3) − 1 = 18 + 3 − 1 = 20，分步代入再合併最穩，得 20。8 可能 x² 算成 3；14 是 −x 符號錯。",
    "steps": [
      "x = −3，x² = 9。",
      "2×9 = 18，−x = 3。",
      "18 + 3 − 1 = 20。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「當 m = 2、n = −1 時，m² + mn 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，2² + 2×(−1) = 4 − 2 = 2，得 2。3 可能 mn 算成 +1；4 是忘加 mn。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "m=2，n=−1。",
      "m² = 4，mn = −2。",
      "4 + (−2) = 2。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「當 x = 4 時，−x² + 5 的值是多少」而言，將題目給定的值代入代數式後依運算順序計算，−(4)² + 5 = −16 + 5 = −11，得 −11。11 是忘負號在前；−21 可能 4² 算 16 又多減。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x = 4。",
      "x² = 16，−x² = −16。",
      "−16 + 5 = −11。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「已知 f(x) = x² − 3x，求 f(2) 的值。」而言，將題目給定的值代入代數式後依運算順序計算，f(2) = 2² − 3×2 = 4 − 6 = −2，得 −2。2 可能 4−6 符號反；10 是 4+6。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "f(2) 表示 x = 2。",
      "算 4 − 6。",
      "得 −2。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「化簡 3x + 5x。」而言，把同類項的係數加減合併，得 8x。3x 與 5x 是同類項，係數 3+5=8，得 8x；8x² 次數弄錯。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "3x 與 5x 是同類項。",
      "係數 3 + 5 = 8。",
      "寫成 8x。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「化簡 7y − 2y + y。」而言，把同類項的係數加減合併，y 的係數 7 − 2 + 1 = 6，得 6y，得 6y。5y 是漏算最後的 +y；4y 是減 2 又漏 +1。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "三項都是 y 的同類項。",
      "係數 7 − 2 + 1。",
      "得 6y。"
    ],
    "commonMistake": "漏算最後的 +y；4y 是減 2 又漏 +1，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "合併同類項：係數相加減，字母部分不變",
    "tags": [
      "多項式",
      "like-terms-combine",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「化簡 4a² + 3a − 2a² + a。」而言，把同類項的係數加減合併，a² 項：4−2=2 得 2a²，a 項：3+1=4 得 4a，所以化簡為 2a² + 4a，得 2a² + 4a。2a²+2a 是 a 項少加；6a² 是把係數相加而非相減。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "a² 項 4 − 2 = 2。",
      "a 項 3 + 1 = 4。",
      "寫 2a² + 4a。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「化簡 −5x + 3 − 2x + 7。」而言，把同類項的係數加減合併，x 項 −5−2=−7x，常數 3+7=10，所以化簡為 −7x + 10，得 −7x + 10。−3x+10 是 x 項只減 5 沒減 2；−7x+4 是常數只加 3。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "合併 x 項 −5 − 2。",
      "合併常數 3 + 7。",
      "得 −7x + 10。"
    ],
    "commonMistake": "x 項只減 5 沒減 2；−7x+4 是常數只加 3，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "合併同類項：係數相加減，字母部分不變",
    "tags": [
      "多項式",
      "like-terms-combine",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「化簡 3x² − x + 2 − 5x² + 4x。」而言，把同類項的係數加減合併，x²：3−5=−2x²，x：−1+4=3x，所以化簡為 −2x² + 3x + 2，常數 2，得 −2x² + 3x + 2。2x² 是 x² 符號反；−5x 是 x 項算成 −1−4。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x² 項 3 − 5 = −2。",
      "x 項 −1 + 4 = 3。",
      "常數 2，寫 −2x² + 3x + 2。"
    ],
    "commonMistake": "x² 符號反；−5x 是 x 項算成 −1−4，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "合併同類項：係數相加減，字母部分不變",
    "tags": [
      "多項式",
      "like-terms-combine",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「下列化簡何者正確原式 6m − 4n + 2m + n」而言，把同類項的係數加減合併，m 項 6+2=8m，n 項 −4+1=−3n，所以化簡為 8m − 3n，不同字母不能合併，得 8m − 3n。8m−5n 是 n 項符號錯；4m 是 m 項相減。",
    "steps": [
      "合併 m：6 + 2 = 8。",
      "合併 n：−4 + 1 = −3。",
      "得 8m − 3n。"
    ],
    "commonMistake": "n 項符號錯；4m 是 m 項相減，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "合併同類項：係數相加減，字母部分不變",
    "tags": [
      "多項式",
      "like-terms-combine",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「化簡 x² + 3x + 1 − 2x² + x − 4。」而言，把同類項的係數加減合併，x²：1−2=−x²，x：3+1=4x，常數 1−4=−3，所以化簡為 −x² + 4x − 3，得 −x² + 4x − 3。x²+4x 是 x² 符號反；−x²+2x 是 x 少加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x² 1 − 2 = −1。",
      "x 3 + 1 = 4。",
      "常數 1 − 4 = −3。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「長方形長 (2x+1)、寬 x，周長化簡後為何」而言，把同類項的係數加減合併，周長 2(長+寬)=2(2x+1+x)=2(3x+1)=6x+2，所以化簡為 6x + 2，周長要記得乘 2，得 6x + 2。2x²+x 像面積；4x+2 是少乘 2。",
    "steps": [
      "長+寬 = 3x + 1。",
      "周長 = 2(3x+1)。",
      "展開得 6x + 2。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「化簡 −(3x − 2) + 5x。（先展開再合併）」而言，把同類項的係數加減合併，−(3x−2)=−3x+2，再加 5x 得 2x+2，所以化簡為 2x + 2，得 2x + 2。8x−2 是括號前負號沒分配到 −2；2x−2 是 +2 變 −2。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−(3x−2) = −3x + 2。",
      "加 5x：2x + 2。",
      "整理得 2x + 2。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「化簡 0.5x + 1.5x。」而言，把同類項的係數加減合併，0.5 + 1.5 = 2，得 2x，小數係數仍要相加，得 2x。2x² 是次數錯；0.65x 是小數相乘。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "兩項都是 x 的同類項。",
      "0.5 + 1.5 = 2。",
      "寫 2x。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "把同類項的係數加減合併，p²q 項 4+1=5p²q，所以化簡為 5p²q − 2pq²，pq² 項 −2pq² 沒同類可合，pq² 與 p²q 字母次數不同，不能合併，得 5p²q − 2pq²。3p²q 是 4+1 算成 3；含 +pq² 是把 pq² 符號弄反。",
    "steps": [
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "去括號後把同類項的係數加減，加法直接去括號：2x+x=3x，3+(−1)=2，得 3x+2，所以化簡為 3x + 2，加號後括號通常不變號，得 3x + 2。3x+4 是常數 3+1 忘變號；x+2 是 2x 漏加。",
    "steps": [
      "去掉括號。",
      "2x + x = 3x。",
      "3 − 1 = 2。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 (5x − 2) − (2x − 1)。」而言，去括號後把同類項的係數加減，減括號要變號：5x−2−2x+1，得 3x−1，得 3x − 1。3x−3 是 +1 沒變；7x 是 5+2 而非 5−2。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−(2x−1) 變 −2x+1。",
      "5x − 2x = 3x。",
      "−2 + 1 = −1。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 (3x² + x) + (x² − 2x)。」而言，去括號後把同類項的係數加減，x²：3+1=4x²，x：1−2=−x，所以化簡為 4x² − x，得 4x² − x。4x²+3x 是 x 項符號反；2x² 是 x² 只加 1。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x² 項 3 + 1 = 4。",
      "x 項 1 − 2 = −1。",
      "寫 4x² − x。"
    ],
    "commonMistake": "x 項符號反；2x² 是 x² 只加 1，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 (4 − 3x) + (2x + 5)。」而言，去括號後把同類項的係數加減，x 項 −3+2=−x，常數 4+5=9，得 9−x，所以化簡為 9 − x，得 9 − x。9+x 是 x 符號反；−x−1 是常數算 4−5。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x 項 −3x + 2x = −x。",
      "常數 4 + 5 = 9。",
      "寫 9 − x。"
    ],
    "commonMistake": "x 符號反；−x−1 是常數算 4−5，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 (x² + 3x + 2) − (x² − x + 1)。」而言，去括號後把同類項的係數加減，x：3−(−1)=4x，常數 2−1=1，所以化簡為 4x + 1，x² 消去，減式每一項都要變號，得 4x + 1。4x+3 是常數 2+1；2x+1 是 x 少加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x² 項相消。",
      "x：3 + 1 = 4。",
      "常數 2 − 1 = 1。"
    ],
    "commonMistake": "常數 2+1；2x+1 是 x 少加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 2(3x + 1) − (x − 4)。（先展開）」而言，去括號後把同類項的係數加減，2(3x+1)=6x+2，減 (x−4) 得 6x+2−x+4=5x+6，所以化簡為 5x + 6，得 5x + 6。5x−2 是 +4 沒加；6x+6 是沒減 x。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "展開 6x + 2。",
      "減 x 加 4。",
      "合併 5x + 6。"
    ],
    "commonMistake": "+4 沒加；6x+6 是沒減 x，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「小明有 (5x+10) 元，花 (2x+3) 元，剩多少」而言，去括號後把同類項的係數加減，(5x+10)−(2x+3)=5x+10−2x−3=3x+7，所以化簡為 3x + 7，花錢用減法且括號變號，得 3x + 7。3x+13 是常數 10+3；7x 是 5+2。",
    "steps": [
      "列式 (5x+10) − (2x+3)。",
      "x 項 5 − 2 = 3。",
      "常數 10 − 3 = 7。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 (−2x + 5) + (3x − 8)。」而言，去括號後把同類項的係數加減，x 項 −2+3=x，常數 5−8=−3，所以化簡為 x − 3，得 x − 3。x+13 是常數 5+8；5x 是 x 係數相加錯。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x：−2 + 3 = 1。",
      "常數 5 − 8 = −3。",
      "得 x − 3。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 (4a − 3b) − (a + 2b)。」而言，去括號後把同類項的係數加減，a：4−1=3a，b：−3−2=−5b，所以化簡為 3a − 5b，得 3a − 5b。3a+b 是 b 項符號全反；5a 是 a 相減弄成加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "a 項 4 − 1 = 3。",
      "b 項 −3 − 2 = −5。",
      "得 3a − 5b。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 (x² + 2) − (2x² − 1)。」而言，去括號後把同類項的係數加減，x²：1−2=−x²，常數 2−(−1)=3，所以化簡為 −x² + 3，得 −x² + 3。−x²+1 是常數 2−1；3x² 是 x² 相減弄成加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x² 1 − 2 = −1。",
      "常數 2 + 1 = 3。",
      "得 −x² + 3。"
    ],
    "commonMistake": "常數 2−1；3x² 是 x² 相減弄成加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 (6x − 1) + (−2x + 4) − (x − 2)。」而言，去括號後把同類項的係數加減，合併 x：6−2−1=3x，常數 −1+4+2=5，所以化簡為 3x + 5，得 3x + 5。3x+1 是常數少加 2；9x 是 x 沒減最後一項。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x：6 − 2 − 1 = 3。",
      "常數 −1 + 4 + 2 = 5。",
      "得 3x + 5。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「若 A = 2x² + x，B = x² − 3x + 1，求 A − B。」而言，去括號後把同類項的係數加減，A−B=(2x²+x)−(x²−3x+1)=x²+4x−1，所以化簡為 x² + 4x − 1，得 x² + 4x − 1。x²−2x 是 x 項 1−(−3) 算錯；3x² 是 x² 相減弄成加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "減 B 每一項變號。",
      "x²：2 − 1 = 1。",
      "x：1 + 3 = 4，常數 −1。"
    ],
    "commonMistake": "x 項 1−(−3) 算錯；3x² 是 x² 相減弄成加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "多項式加減：去括號後合併同類項，減法要變號",
    "tags": [
      "多項式",
      "polynomial-add-subtract",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 3x · 4x。」而言，將各因式的係數與次方分別計算，係數 3×4=12，x 指數 1+1=2，得 12x²，得 12x²。7x 是係數相加；12x 是次數沒加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 3 × 4 = 12。",
      "x 指數 1 + 1 = 2。",
      "得 12x²。"
    ],
    "commonMistake": "係數相加；12x 是次數沒加，化簡時粗心漏項或算錯係數就容易選錯。",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 (−2x²) · 5x³。」而言，將各因式的係數與次方分別計算，係數 (−2)×5=−10，指數 2+3=5，得 −10x⁵，得 −10x⁵。−10x⁶ 是指數多 1；3x⁵ 是係數相加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 −2 × 5 = −10。",
      "指數 2 + 3 = 5。",
      "得 −10x⁵。"
    ],
    "commonMistake": "指數多 1；3x⁵ 是係數相加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式相乘：係數相乘，同底數指數相加",
    "tags": [
      "多項式",
      "monomial-multiply",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 6a²b · (−3ab²)。」而言，將各因式的係數與次方分別計算，係數 6×(−3)=−18，a 指數 2+1=3，b 指數 1+2=3，b 指數只加一個字母，得 −18a³b³。−18a²b² 是指數沒加；3a³ 是係數相加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 −18。",
      "a 指數 3，b 指數 3。",
      "得 −18a³b³。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 x⁴ · x²。」而言，將各因式的係數與次方分別計算，同底 x，指數 4+2=6，得 x⁶，同底相乘指數加，係數視為 1，得 x⁶。x⁸ 是 4×2；2x⁶ 是係數多 2。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "底數都是 x。",
      "指數 4 + 2 = 6。",
      "得 x⁶。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 (−4y³) · (−2y)。」而言，將各因式的係數與次方分別計算，係數 (−4)×(−2)=8，指數 3+1=4，得 8y⁴，得 8y⁴。−8 是負負沒變正；6y⁴ 是係數相加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 8。",
      "指數 3 + 1 = 4。",
      "得 8y⁴。"
    ],
    "commonMistake": "負負沒變正；6y⁴ 是係數相加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式相乘：係數相乘，同底數指數相加",
    "tags": [
      "多項式",
      "monomial-multiply",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 5 · 3x²。」而言，將各因式的係數與次方分別計算，常數 5 與 3x² 相乘：5×3=15，x² 不變，得 15x²，得 15x²。8x² 是 5+3；15x 是 x² 次數掉。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 5 × 3 = 15。",
      "x² 保留。",
      "得 15x²。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 (2x)³。（視為三個 2x 相乘）」而言，將各因式的係數與次方分別計算，2³=8，x³ 保留，得 8x³，整個單項式要一起乘三次，得 8x³。6x³ 是 2×3；8x 是 x 次數沒乘 3。",
    "steps": [
      "2³ = 8。",
      "x 乘三次得 x³。",
      "得 8x³。"
    ],
    "commonMistake": "2×3；8x 是 x 次數沒乘 3，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式相乘：係數相乘，同底數指數相加",
    "tags": [
      "多項式",
      "monomial-multiply",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「長方形長 2x、寬 3x，面積是多少」而言，將各因式的係數與次方分別計算，面積 2x×3x=6x²，面積用乘法，x 指數要加，得 6x²。5x 是長寬相加；6x 是係數乘但 x 次數沒加。",
    "steps": [
      "面積 = 長 × 寬。",
      "2x × 3x。",
      "得 6x²。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 4m²n · 5mn³。」而言，將各因式的係數與次方分別計算，係數 20，m 指數 2+1=3，n 指數 1+3=4，得 20m³n⁴。20m²n³ 是指數沒全加；9 是係數加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 4×5=20。",
      "m：2+1，n：1+3。",
      "得 20m³n⁴。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 (−x²) · 3x · (−2x⁴)。」而言，將各因式的係數與次方分別計算，三個因式 (−x²)·3x·(−2x⁴) 相乘：係數 (−1)×3×(−2)=6，指數 2+1+4=7，得 6x⁷，得 6x⁷。−6x⁷ 是符號弄錯；6x⁶ 是指數少加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 (−1)×3×(−2)=6。",
      "指數 2+1+4=7。",
      "得 6x⁷。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 10x⁵ ÷ 2x²。（單項式除法，係數相除、指數相減）」而言，將各因式的係數與次方分別計算，係數 10÷2=5，指數 5−2=3，得 5x³，除法指數相減，得 5x³。5x⁷ 是指數相減弄成加；8x³ 是係數相減。",
    "steps": [
      "係數 10 ÷ 2 = 5。",
      "指數 5 − 2 = 3。",
      "得 5x³。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 (−6a³b²) · (−a²b)。」而言，將各因式的係數與次方分別計算，係數 (−6)×(−1)=6，a 指數 3+2=5，b 指數 2+1=3，得 6a⁵b³。−6 是符號錯；a⁶ 是指數加錯。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "係數 6。",
      "a 指數 5，b 指數 3。",
      "得 6a⁵b³。"
    ],
    "commonMistake": "符號錯；a⁶ 是指數加錯，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式相乘：係數相乘，同底數指數相加",
    "tags": [
      "多項式",
      "monomial-multiply",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 2(x + 3)。」而言，用分配律把外項乘進括號內每一項，2 乘 x 得 2x，2 乘 3 得 6，得 2x+6，分配律每一項都要乘，得 2x + 6。2x+3 是 3 沒乘 2；x+6 是 x 沒乘 2。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "2 × x = 2x。",
      "2 × 3 = 6。",
      "得 2x + 6。"
    ],
    "commonMistake": "3 沒乘 2；x+6 是 x 沒乘 2，化簡時粗心漏項或算錯係數就容易選錯。",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 −3(2x − 1)。」而言，用分配律把外項乘進括號內每一項，−3×2x=−6x，−3×(−1)=+3，得 −6x+3，所以得 −6x + 3，得 −6x + 3。−6x−3 是 −1 沒變正；6x+3 是 x 符號反。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−3 × 2x = −6x。",
      "−3 × (−1) = 3。",
      "得 −6x + 3。"
    ],
    "commonMistake": "−1 沒變正；6x+3 是 x 符號反，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 x(x + 4)。」而言，用分配律把外項乘進括號內每一項，x·x=x²，x·4=4x，得 x²+4x，所以得 x² + 4x，得 x² + 4x。x²+4 是 4 沒乘 x；2x+4 是 x 當係數加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "x × x = x²。",
      "x × 4 = 4x。",
      "得 x² + 4x。"
    ],
    "commonMistake": "4 沒乘 x；2x+4 是 x 當係數加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 4(2x² − x + 1)。」而言，用分配律把外項乘進括號內每一項，分別得 8x²、−4x、4，三項都要乘 4，得 8x² − 4x + 4。8x²−x+4 是 x 項沒乘 4；6x² 是 4+2。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "4×2x²=8x²。",
      "4×(−x)=−4x。",
      "4×1=4。"
    ],
    "commonMistake": "x 項沒乘 4；6x² 是 4+2，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 −2(3 − x)。」而言，用分配律把外項乘進括號內每一項，−2×3=−6，−2×(−x)=+2x，得 −6+2x，所以得 −6 + 2x，得 −6 + 2x。−6−2x 是 −x 沒變正；6+2x 是 −6 符號反。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−2 × 3 = −6。",
      "−2 × (−x) = 2x。",
      "得 −6 + 2x。"
    ],
    "commonMistake": "−x 沒變正；6+2x 是 −6 符號反，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 5x(2x + 1)。」而言，用分配律把外項乘進括號內每一項，5x·2x=10x²，5x·1=5x，所以得 10x² + 5x，單項式乘多項式兩項都要乘，得 10x² + 5x。7x² 是 5+2；10x+5 是 x² 掉。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "5x × 2x = 10x²。",
      "5x × 1 = 5x。",
      "得 10x² + 5x。"
    ],
    "commonMistake": "5+2；10x+5 是 x² 掉，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「長方形長 (x+2)、寬 3，面積展開後為何」而言，用分配律把外項乘進括號內每一項，面積 3(x+2)=3x+6，所以得 3x + 6，得 3x + 6。3x+2 是 2 沒乘 3；x+6 是 x 沒乘 3。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "面積 = 3(x+2)。",
      "3×x=3x，3×2=6。",
      "得 3x + 6。"
    ],
    "commonMistake": "2 沒乘 3；x+6 是 x 沒乘 3，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 −x(4x − 3)。」而言，用分配律把外項乘進括號內每一項，−x·4x=−4x²，−x·(−3)=+3x，所以得 −4x² + 3x，得 −4x² + 3x。−4x²−3x 是 −3 沒變正；4x² 是 x 係數 −1 漏掉。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−x × 4x = −4x²。",
      "−x × (−3) = 3x。",
      "得 −4x² + 3x。"
    ],
    "commonMistake": "−3 沒變正；4x² 是 x 係數 −1 漏掉，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「計算 2a(3a − 2b + 5)。」而言，用分配律把外項乘進括號內每一項，2a·3a=6a²，2a·(−2b)=−4ab，2a·5=10a，所以得 6a² − 4ab + 10a，得 6a² − 4ab + 10a。6a²−4b 是 b 沒乘 a；5a² 是係數加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "2a×3a=6a²。",
      "2a×(−2b)=−4ab。",
      "2a×5=10a。"
    ],
    "commonMistake": "b 沒乘 a；5a² 是係數加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「計算 −4(x² + x − 1)。」而言，用分配律把外項乘進括號內每一項，三項分別 −4x²、−4x、+4，得 −4x² − 4x + 4。−4x²−4x−4 是 −1×(−4) 算成 −4；+4x 是 x 項符號反。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "−4×x²=−4x²。",
      "−4×x=−4x。",
      "−4×(−1)=4。"
    ],
    "commonMistake": "−1×(−4) 算成 −4；+4x 是 x 項符號反，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「計算 3xy(2x − y)。」而言，用分配律把外項乘進括號內每一項，3xy·2x=6x²y，3xy·(−y)=−3xy²，所以得 6x²y − 3xy²，得 6x²y − 3xy²。6x²y−3xy 是 y 指數沒加；5x²y 是係數加。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "3xy×2x=6x²y。",
      "3xy×(−y)=−3xy²。",
      "寫 6x²y − 3xy²。"
    ],
    "commonMistake": "y 指數沒加；5x²y 是係數加，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「計算 −(2x + 5) + 3(x − 1)。（先分配再合併）」而言，用分配律把外項乘進括號內每一項，−2x−5+3x−3=x−8，所以得 x − 8，先分配再去括號合併，得 x − 8。x−2 是常數 −5−3 算錯；5x 是 x 合併錯。",
    "steps": [
      "−(2x+5)=−2x−5。",
      "3(x−1)=3x−3。",
      "合併 x−8。"
    ],
    "commonMistake": "常數 −5−3 算錯；5x 是 x 合併錯，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "單項式乘多項式：分配律，括號內每一項都要乘到",
    "tags": [
      "多項式",
      "monomial-polynomial-distribute",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「(x + 3)(x − 3) 展開後為何」而言，用平方差公式展開，(x + 3)(x − 3) = x² − 3x + 3x − 9 = x² − 9，中間項消去，x² + 9 把符號全當正，x² + 6x − 9 把一次項留下，沒看出加減配對會抵消，得 x² − 9。x² − 6x + 9 是 (x − 3)² 的展開。",
    "steps": [
      "x 乘 x − 3：x² − 3x。",
      "3 乘 x − 3：3x − 9。",
      "合併：3x − 3x 消去，整理成 x² − 9。"
    ],
    "commonMistake": "(x − 3)² 的展開，化簡時粗心漏項或算錯係數就容易選錯。",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「(2x + 5)(2x − 5) 展開後為何」而言，用平方差公式展開，(2x)² − 5² = 4x² − 25，中間項 2·2x·5 與 −2·2x·5 抵消，2x² − 25 二次項係數沒平方，帶係數的平方差要先算 (2x)²，得 4x² − 25。4x² + 25 常數項符號錯；4x² − 20x + 25 是 (2x − 5)²。",
    "steps": [
      "第一項 (2x)² = 4x²。",
      "第二項 5² = 25。",
      "中間項抵消，整理成 4x² − 25。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「(x + 1)(x − 1) 展開後為何」而言，用平方差公式展開，x² − x + x − 1 = x² − 1，x² + 2x − 1 一次項沒消去，最簡單的平方差也要看出中間項為零，得 x² − 1。x² + 1 常數項符號錯；x² − 2x + 1 是 (x − 1)²。",
    "steps": [
      "x 乘 x − 1：x² − x。",
      "1 乘 x − 1：x − 1。",
      "合併：x² − 1。"
    ],
    "commonMistake": "x² + 1 常數項符號錯；x² − 2x + 1 是 (x − 1)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「(3x + 4)(3x − 4) 展開後為何」而言，用平方差公式展開，(3x)² − 4² = 9x² − 16，得 9x² − 16。9x² + 16 符號錯；9x² − 24x + 16 是完全平方差。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "(3x)² = 9x²。",
      "4² = 16。",
      "中間項消去，整理成 9x² − 16。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「(x + 6)(x − 6) 展開後為何」而言，用平方差公式展開，分配律展開得 x² − 6x + 6x − 36 = x² − 36，中間正負一次項會互相抵消，x² − 6 只減 6 沒有平方，6² 應為 36，得 x² − 36。x² + 36 常數符號反；x² − 12x + 36 是 (x − 6)²。",
    "steps": [
      "分配律展開四項。",
      "+6x 與 −6x 抵消。",
      "得 x² − 36。"
    ],
    "commonMistake": "x² + 36 常數符號反；x² − 12x + 36 是 (x − 6)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「(5x + 1)(5x − 1) 展開後為何」而言，用平方差公式展開，得 25x² − 1。25x² + 1 符號錯；25x² − 10x + 1 是 (5x − 1)²。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "(5x)² = 25x²。",
      "1² = 1。",
      "中間項消去，整理成 25x² − 1。"
    ],
    "commonMistake": "25x² + 1 符號錯；25x² − 10x + 1 是 (5x − 1)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「(x + 9)(x − 9) 展開後為何」而言，用平方差公式展開，分配律得 x² − 9x + 9x − 81 = x² − 81，正負一次項相加為零才只剩平方差，得 x² − 81。x² + 81 符號錯；x² − 18x + 81 是 (x − 9)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "展開得 x² − 9x + 9x − 81。",
      "中間兩項相加為 0。",
      "得 x² − 81。"
    ],
    "commonMistake": "x² + 81 符號錯；x² − 18x + 81 是 (x − 9)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「(4x + 3)(4x − 3) 展開後為何」而言，用平方差公式展開，(4x)² − 3² = 16x² − 9，得 16x² − 9。16x² + 9 符號錯；16x² − 24x + 9 是完全平方差。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "(4x)² = 16x²。",
      "3² = 9。",
      "得 16x² − 9。"
    ],
    "commonMistake": "16x² + 9 符號錯；16x² − 24x + 9 是完全平方差，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「(x + 2)(x − 2) 展開後為何」而言，用平方差公式展開，分配律得 x² − 2x + 2x − 4 = x² − 4，小數字也要把常數平方，得 x² − 4。x² + 4 常數符號錯；x² − 4x + 4 是 (x − 2)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "分配律：x² − 2x + 2x − 4。",
      "中間項消去。",
      "得 x² − 4。"
    ],
    "commonMistake": "x² + 4 常數符號錯；x² − 4x + 4 是 (x − 2)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「(7x + 2)(7x − 2) 展開後為何」而言，用平方差公式展開，(7x)² − 2² = 49x² − 4，得 49x² − 4。49x² + 4 符號錯；49x² − 28x + 4 是 (7x − 2)²。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "(7x)² = 49x²。",
      "2² = 4。",
      "中間項消去，整理成 49x² − 4。"
    ],
    "commonMistake": "49x² + 4 符號錯；49x² − 28x + 4 是 (7x − 2)²，化簡時粗心漏項或算錯係數就容易選錯。",
    "concept": "(a + b)(a − b) = a² − b²，兩項中間符號一正一負，展開後中間項會消去只剩平方差；只做展開辨識，不反過來問因式分解",
    "tags": [
      "多項式",
      "difference-of-squares-expand",
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「(x + 8)(x − 8) 展開後為何」而言，用平方差公式展開，得 x² − 64。分配律得 x² − 8x + 8x − 64 = x² − 64，大數字平方常數項別漏算；x² + 64 符號錯。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "展開四項。",
      "±8x 抵消。",
      "得 x² − 64。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「一長方形長 (a + 5) 公尺、寬 (a − 5) 公尺，面積展開後為何」而言，用平方差公式展開，面積 = (a + 5)(a − 5) = a² − 25，長寬一加一減用平方差，a² − 5 沒平方 5，面積模型要看出中間項會消去，得 a² − 25。a² + 25 符號錯；a² − 10a + 25 是 (a − 5)²。",
    "steps": [
      "面積 = 長 × 寬 = (a + 5)(a − 5)。",
      "套用平方差：a² − 5²。",
      "得 a² − 25。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「(x + 3)² 的正確展開為何」而言，先辨認題目型態再展開，得 x² + 6x + 9。(x + 3)² 是完全平方和，x² + 6x + 9；x² − 6x + 9 是 (x − 3)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "型式是 (a + b)²，兩項中間為加。",
      "套用 x² + 2·x·3 + 9。",
      "得 x² + 6x + 9。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「(x − 4)² 的正確展開為何」而言，先辨認題目型態再展開，得 x² − 8x + 16。(x − 4)² 是完全平方差，x² − 8x + 16；x² + 8x + 16 是 (x + 4)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "型式是 (a − b)²。",
      "中間項 −2·x·4 = −8x。",
      "得 x² − 8x + 16。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「(x + 5)(x − 5) 的正確展開為何」而言，先辨認題目型態再展開，兩括號同名異號，用平方差 x² − 25，得 x² − 25。x² + 10x + 25 是 (x + 5)²；x² − 10x + 25 是 (x − 5)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "兩括號：x + 5 與 x − 5，異號配對。",
      "用平方差 a² − b²。",
      "得 x² − 25。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「(2x + 1)² 的正確展開為何」而言，先辨認題目型態再展開，(2x + 1)² = 4x² + 4x + 1，帶係數的完全平方和仍要寫出三項，得 4x² + 4x + 1。4x² − 4x + 1 是 (2x − 1)²；4x² − 1 是 (2x + 1)(2x − 1)。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "(2x)² = 4x²。",
      "2·2x·1 = 4x。",
      "1² = 1，整理成 4x² + 4x + 1。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「下列哪一個是 (3x − 2)² 的展開」而言，先辨認題目型態再展開，(3x − 2)² = 9x² − 12x + 4，得 9x² − 12x + 4。9x² + 12x + 4 是 (3x + 2)²；9x² − 4 是 (3x + 2)(3x − 2)。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "確認 (3x − 2)² 是減號平方。",
      "−2·3x·2 = −12x。",
      "得 9x² − 12x + 4。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「下列哪一個是 (x + 7)(x − 7) 的展開」而言，先辨認題目型態再展開，平方差 (x + 7)(x − 7) = x² − 49，得 x² − 49。x² + 14x + 49 是 (x + 7)²；x² − 14x + 49 是 (x − 7)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "兩括號一正一負，同名 7。",
      "用 a² − b²。",
      "得 x² − 49。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「(4x + 3)² 應展開成哪一式」而言，先辨認題目型態再展開，(4x + 3)² = 16x² + 24x + 9，加號平方中間項為正兩倍乘積，得 16x² + 24x + 9。16x² − 9 是平方差；16x² − 24x + 9 是 (4x − 3)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "型式 (a + b)²，a = 4x，b = 3。",
      "2·4x·3 = 24x。",
      "得 16x² + 24x + 9。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「(5x − 1)(5x + 1) 應展開成哪一式」而言，先辨認題目型態再展開，(5x − 1)(5x + 1) = 25x² − 1，平方差，得 25x² − 1。25x² − 10x + 1 是 (5x − 1)²；25x² + 10x + 1 是 (5x + 1)²。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "兩括號 5x ± 1，異號。",
      "(5x)² − 1²。",
      "得 25x² − 1。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「下列哪一式等於 (x − 1)²」而言，先辨認題目型態再展開，(x − 1)² = x² − 2x + 1，得 x² − 2x + 1。x² + 2x + 1 是 (x + 1)²；x² − 1 是 (x + 1)(x − 1)。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "原式 (x − 1)²，減號平方。",
      "−2·x·1 = −2x。",
      "得 x² − 2x + 1。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「下列哪一式等於 (2x + 3)(2x − 3)」而言，先辨認題目型態再展開，(2x + 3)(2x − 3) = 4x² − 9，得 4x² − 9。4x² + 12x + 9 是 (2x + 3)²；4x² − 12x + 9 是 (2x − 3)²。計算時每一項係數與正負號都要算清楚。每一步乘法或合併都要寫清楚，避免算錯係數與符號。",
    "steps": [
      "兩括號 2x ± 3，平方差型。",
      "(2x)² − 3²。",
      "得 4x² − 9。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「某式為 (x + 2)²，下列展開何者正確」而言，先辨認題目型態再展開，得 x² + 4x + 4。(x + 2)² = x² + 4x + 4，加號平方三項結構固定不可漏一次項；x² − 4 是平方差。",
    "steps": [
      "加號平方 (x + 2)²。",
      "2·x·2 = 4x。",
      "得 x² + 4x + 4。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「一長方形長 (2a + 1) 公分、寬 (2a − 1) 公分，面積展開後為何」而言，先辨認題目型態再展開，長寬異號配對，(2a + 1)(2a − 1) = 4a² − 1，得 4a² − 1。4a² + 4a + 1 是 (2a + 1)²；4a² − 4a + 1 是 (2a − 1)²。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "面積 = (2a + 1)(2a − 1)。",
      "辨識平方差型。",
      "(2a)² − 1² = 4a² − 1。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「一塊矩形土地，東西向長 (x + 4) 公尺、南北向寬 (x + 2) 公尺，面積展開後為何」而言，依題意列出面積或代數式再展開，矩形面積 = 長 × 寬 = (x + 4)(x + 2) = x² + 2x + 4x + 8 = x² + 6x + 8，x² + 8x + 6 一次項與常數對調，得 x² + 6x + 8。2x² + 6x + 8 二次項係數錯。",
    "steps": [
      "面積 = (x + 4)(x + 2)。",
      "分配律：x² + 2x + 4x + 8。",
      "合併得 x² + 6x + 8。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「一張紙切成邊長 (a + 3) 公分的正方形，面積展開後為何」而言，依題意列出面積或代數式再展開，正方形面積 = (a + 3)² = a² + 6a + 9，a² + 6a + 6 常數 3² 算成 6，邊長平方要用完全平方和公式，得 a² + 6a + 9。a² + 3a + 9 中間項少乘 2；a² + 9 漏 6a。",
    "steps": [
      "面積 = 邊長² = (a + 3)²。",
      "a² + 2·a·3 + 9。",
      "得 a² + 6a + 9。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "依題意列出面積或代數式再展開，長寬異號，(2y − 1)(2y + 1) = 4y² − 1，得 4y² − 1。4y² + 4y − 1 與 4y² − 4y − 1 都是完全平方展開；4y² + 1 符號錯，玻璃面積一加一減用平方差，中間項會消去。",
    "steps": [
      "面積 = (2y − 1)(2y + 1)。",
      "辨識平方差。",
      "(2y)² − 1² = 4y² − 1。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「一塊菜園圍成邊長 (m − 5) 公尺的正方形，面積展開後為何」而言，依題意列出面積或代數式再展開，(m − 5)² = m² − 10m + 25，得 m² − 10m + 25。m² − 5m + 25 中間項少乘 2；m² + 10m + 25 是 (m + 5)²。",
    "steps": [
      "面積 = (m − 5)²。",
      "−2·m·5 = −10m。",
      "得 m² − 10m + 25。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「一塊木板，長 (3x + 2) 公分、寬 (3x − 2) 公分，面積展開後為何」而言，依題意列出面積或代數式再展開，木板面積 (3x + 2)(3x − 2) = 9x² − 4，得 9x² − 4。9x² + 12x − 4 是 (3x + 2)² 的一部分錯誤；9x² − 12x + 4 是 (3x − 2)²。",
    "steps": [
      "面積 = (3x + 2)(3x − 2)。",
      "(3x)² − 2²。",
      "得 9x² − 4。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「一塊矩形草坪，長 (n + 6) 公尺、寬 (n − 1) 公尺，面積展開後為何」而言，依題意列出面積或代數式再展開，(n + 6)(n − 1) = n² − n + 6n − 6 = n² + 5n − 6，得 n² + 5n − 6。n² + 7n − 6 一次項合併錯；n² − 5n − 6 符號反。",
    "steps": [
      "面積 = (n + 6)(n − 1)。",
      "n² − n + 6n − 6。",
      "合併得 n² + 5n − 6。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「一塊正方形磁磚，邊長 (t + 8) 公分，面積展開後為何」而言，依題意列出面積或代數式再展開，(t + 8)² = t² + 16t + 64，得 t² + 16t + 64。t² + 8t + 64 中間項少乘 2；t² + 64 漏 16t。計算時每一項係數與正負號都要算清楚。",
    "steps": [
      "面積 = (t + 8)²。",
      "2·t·8 = 16t。",
      "8² = 64，整理成 t² + 16t + 64。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「一塊長方形桌布，長 (4a + 1) 公分、寬 (4a − 1) 公分，面積展開後為何」而言，依題意列出面積或代數式再展開，桌布面積 (4a + 1)(4a − 1) = 16a² − 1，得 16a² − 1。16a² + 8a − 1 與 16a² − 8a − 1 是完全平方型；16a² + 1 符號錯，桌布長寬一加一減是平方差模型。",
    "steps": [
      "面積 = (4a + 1)(4a − 1)。",
      "平方差：(4a)² − 1²。",
      "得 16a² − 1。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "就「一塊矩形花圃，長 (p − 3) 公尺、寬 (p − 2) 公尺，面積展開後為何」而言，依題意列出面積或代數式再展開，(p − 3)(p − 2) = p² − 2p − 3p + 6 = p² − 5p + 6，得 p² − 5p + 6。p² − p − 6 一次項合併錯；p² + 5p + 6 符號全反。",
    "steps": [
      "面積 = (p − 3)(p − 2)。",
      "p² − 2p − 3p + 6。",
      "合併得 p² − 5p + 6。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "就「一塊正方形告示牌，邊長 (5w − 3) 公分，面積展開後為何」而言，依題意列出面積或代數式再展開，(5w − 3)² = 25w² − 30w + 9，得 25w² − 30w + 9。25w² − 15w + 9 中間項少乘 2；25w² + 30w + 9 符號反。",
    "steps": [
      "面積 = (5w − 3)²。",
      "(5w)² − 2·5w·3 + 9。",
      "得 25w² − 30w + 9。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "就「一塊矩形地毯，長 (2b + 5) 公尺、寬 (2b − 5) 公尺，面積展開後為何」而言，依題意列出面積或代數式再展開，地毯面積 (2b + 5)(2b − 5) = 4b² − 25，得 4b² − 25。4b² + 20b − 25 是 (2b + 5)² 型；4b² − 20b − 25 是 (2b − 5)² 型。",
    "steps": [
      "面積 = (2b + 5)(2b − 5)。",
      "平方差 (2b)² − 5²。",
      "得 4b² − 25。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "就「一塊矩形水池，長 (x + 1) 公尺、寬 (x + 9) 公尺，面積展開後為何」而言，依題意列出面積或代數式再展開，水池面積 (x + 1)(x + 9) = x² + 9x + x + 9 = x² + 10x + 9，得 x² + 10x + 9。x² + 8x + 9 一次項合併錯；x² + 9x + 9 漏 x·9 中的一部分。",
    "steps": [
      "面積 = (x + 1)(x + 9)。",
      "x² + 9x + x + 9。",
      "合併得 x² + 10x + 9。"
