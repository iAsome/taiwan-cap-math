window.EXAM_ENGINE = (() => {
  ...
  function mc(r, unitId, difficulty, text, correct, distractors, steps, tip, trap, concept) {
    ...
    return MATH_TEXT_SANITIZE.sanitizeQuestion({ type: "mc", unitId, difficulty, text, choices, answer: choices.indexOf(correctNorm), steps, tip, trap, concept: concept || U[unitId - 1].summary, formula: U[unitId - 1].formula });
  }
