...
import { migrateHumanProductionStorage, retireLegacyMathStorage, migrateHumanContentVersion } from "./storage-migration.mjs";
...
export async function installHumanProductionRuntime() {
  ...
  const contentVersionMigration = migrateHumanContentVersion(HUMAN_PRODUCTION_CONFIG.expectedContentVersion);
