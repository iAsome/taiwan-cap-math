...
export const LECTURE = {
  ...
  "workedExamples": [
    {
      "exampleId": "L1",
      "prompt": "地圖比例尺 1:25000，一塊相似園區在圖上的邊界周長為 18 公分，實際周長多少公里？",
      "solutionSteps": [
  ...
  "commonMistakes": [
    {
      "mistake": "比例尺 1:25000 直接把公分答案當公里。",
      "why": "漏做單位換算。",
  ...
  "lectureReview": {
    ...
    "reviewNote": "比例尺例題完整執行公分至公里換算；百分比、面積反推周長比及固定接合餘量三種易混情境均分開處理，未把非幾何量納入縮放。"
  },
  "contentSha256": "1513c60eda66185d614c3ccde664c922ac8e31aac10ee6aa90ea7e9977c1b088"
};
