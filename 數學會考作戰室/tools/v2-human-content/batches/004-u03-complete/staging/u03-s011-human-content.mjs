...
export const LECTURE = {
  ...
  "contentSha256": "69cd1708c46d76d85f69d304e2ddd353bfa6fb7777e4215ad515fc33040b4561",
...
export const QUESTIONS = [
  {
    ...
    "answerIndex": 0,
    "explanation": "每人4顆；列4x=48；解得12人。所以答案是「12」。",
    "steps": [
      "每人4顆",
      "列4x=48",
      "解得12人"
    ...
    "contentSha256": "0bb28b3867ba3d35a64906b358d61bab7c84070d28ccbe5708088fe1f4b9eca6",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "先算已分42顆；再加剩下5顆；原有47顆。所以答案是「47」。",
    "steps": [
      "先算已分42顆",
      "再加剩下5顆",
      "原有47顆"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "8ab92f742c894ee76267a2dd02e9deff541b8a4176465778bde2ded35bca5a47",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "列15x=90；兩邊除15；得到6個書架。所以答案是「6」。",
    "steps": [
      "列15x=90",
      "兩邊除15",
      "得到6個書架"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "0c0498794b20b3e9f322c020989aec1ef51be800bacab028821777f9105eec92",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "前面有x-1個完整組；列8(x-1)+5=53；解得7組。所以答案是「7」。",
    "steps": [
      "前面有x-1個完整組",
      "列8(x-1)+5=53",
      "解得7組"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "13ad79618e2cd37402e2d2aed89d3cff2fc99516a5bdaefb3935be1ad8032c13",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "扣除散裝3件；45件分5箱；每箱9件。所以答案是「9」。",
    "steps": [
      "扣除散裝3件",
      "45件分5箱",
      "每箱9件"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "4b1c9637646bf568509c0cb57285854a6814d009ccf85989b2b6d786aa683f90",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "扣除剩餘1公尺；119公尺分7段；每段17公尺。所以答案是「17」。",
    "steps": [
      "扣除剩餘1公尺",
      "119公尺分7段",
      "每段17公尺"
    ...
    "optionAnalysis": [
      ...
      },
      {
        "choice": "17",
        "truth": true,
        "reason": "7x+1=120，7x=119，所以x=17。 因此此選項符合題目。"
      },
      {
        "choice": "18",
        "truth": false,
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "6114ed79461f468af3c6f1828c9fbb2f3666495b712cc179a02f3a197ac7a072",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "實到=原總數-請假；列4x-6=130；解得34。所以答案是「34」。",
    "steps": [
      "實到=原總數-請假",
      "列4x-6=130",
      "解得34"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "819d9c757797b03bce2bfaf06610ebfaff6d8d3b678499fc06ed6a1b6c578f4f",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "每人300元；列300x=2400；除300得8人。所以答案是「8」。",
    "steps": [
      "每人300元",
      "列300x=2400",
      "除300得8人"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "14b489c9c343a34d0ddb6653ce63ce34e0bc563b7d7f388f7735c34d3ef7c8f8",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "先扣保留12個；剩144個；每包6個得24包。所以答案是「24」。",
    "steps": [
      "先扣保留12個",
      "剩144個",
      "每包6個得24包"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "ae4634736e753625f41bfc5a99560a6d7be83ea67d34c0d917ac1718a6684d54",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "可用=原總座位-5；列9x-5=148；解得17。所以答案是「17」。",
    "steps": [
      "可用=原總座位-5",
      "列9x-5=148",
      "解得17"
    ...
    "optionAnalysis": [
      ...
      },
      {
        "choice": "17",
        "truth": true,
        "reason": "9x-5=148，9x=153，所以x=17。 因此此選項符合題目。"
      }
    ],
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "b4c5c99b405dc2d3524281de0d4ec001d7c8859ce898892f1339dc5aad5b1f00",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "扣除額外24頁；正文共480頁；除12得40頁。所以答案是「40」。",
    "steps": [
      "扣除額外24頁",
      "正文共480頁",
      "除12得40頁"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "819433b4780c93e4b58b6017b1fc89cebf865c0b39bb62cbbe68f447e1be951d",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "先求原總量504瓶；列24x=504；解得21箱。所以答案是「21」。",
    "steps": [
      "先求原總量504瓶",
      "列24x=504",
      "解得21箱"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "11caccdf2d2ff24bd10f4df41bc565d59f23ce15ff4e584d5127d651b57e2d03",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  }
];
...
export const CONSTRUCTED_RESPONSES = [
  {
    ...
    "contentSha256": "fc85b6d93acd1dc3c69f924ef04df5baa1571db59fe20b677f9aba1ae2c133c1",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "contentSha256": "a3e71ae9bd233c234848d5e302e105fc45cb4249d00ca8d2537d568133b0b9bd",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  }
];
