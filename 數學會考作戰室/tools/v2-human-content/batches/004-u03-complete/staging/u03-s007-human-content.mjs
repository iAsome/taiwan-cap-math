...
export const LECTURE = {
  ...
  "contentSha256": "ffb95d27cbd419bf9414bd9374a2229fb2f9a9683735704ee74962b952f2f8e1",
...
export const QUESTIONS = [
  {
    ...
    "answerIndex": 0,
    "explanation": "把4代入左邊；算得9；比較左右兩邊相等。所以答案是「是，左邊等於9」。",
    "steps": [
      "把4代入左邊",
      "算得9",
      "比較左右兩邊相等"
    ...
    "contentSha256": "b4edbd6cdeeb19b4ead8277584ccc5aef6a1a3361a3b3a516886b38c7aec6fce",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "將-3以括號代入；減去負數變加3；左右同為8。所以答案是「是，5－(－3)＝8」。",
    "steps": [
      "將-3以括號代入",
      "減去負數變加3",
      "左右同為8"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "e0348a749adcc43f46ee564650614842ee7800693452d35d4368929ea74fd2ae",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "兩邊加2得3x=12；除3得4；代入核對。所以答案是「4」。",
    "steps": [
      "兩邊加2得3x=12",
      "除3得4",
      "代入核對"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "81cf8f1559a370701b05fe68f3f0edee88237b40ea7ca1b679f37d5e6d7ee069",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "代入括號得1；左邊為4；4不等於5。所以答案是「不是，左邊為4」。",
    "steps": [
      "代入括號得1",
      "左邊為4",
      "4不等於5"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "2794dabad51c30a7e7567a9f87fd0a427e848802a2739dfba6e08d34ebfff5f5",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "代入-2；左邊算得1；與右邊比較。所以答案是「是」。",
    "steps": [
      "代入-2",
      "左邊算得1",
      "與右邊比較"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "660c63b6a0582f2330533975675758543bfc42ae55656f7e389907464f8226ec",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "解得x/3=3；乘3得9；代入核對。所以答案是「9」。",
    "steps": [
      "解得x/3=3",
      "乘3得9",
      "代入核對"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "e6b418414f25b46ceb4fc479205dc821ea7298b3bb1271df87ceed13c57c4f37",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "代入候選值5；左邊為7；與右邊4不等。所以答案是「錯，代入後左邊為7」。",
    "steps": [
      "代入候選值5",
      "左邊為7",
      "與右邊4不等"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "eb923679c055a7e6f502245e5d3ffea67b9382a6f92c34b8026dbf7d950fef83",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "分別計算左邊15；計算右邊15；判定為解。所以答案是「左右皆為15，是解」。",
    "steps": [
      "分別計算左邊15",
      "計算右邊15",
      "判定為解"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "158b4c950bebf04e697dcb52acd96367d8c85fffcb6166d46208111a4990575d",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "逐式代入-1；第一式左邊-1；其餘式排除。所以答案是「4x＋3＝－1」。",
    "steps": [
      "逐式代入-1",
      "第一式左邊-1",
      "其餘式排除"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "5f942741bd64f07cb39100f1a1fc312c5e0fe7ad11e5544d10bdbf3ad667905e",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "計算3×15=45；與月租相加得244；符合帳單。所以答案是「正確，199＋45＝244」。",
    "steps": [
      "計算3×15=45",
      "與月租相加得244",
      "符合帳單"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "9e3aaf72b111264af1b86a819977aa754a745f2676c8abfdc10c54dd589baf91",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "代入8張票得960元；加郵寄費60元；總額1020元。所以答案是「正確，總額為1020元」。",
    "steps": [
      "代入8張票得960元",
      "加郵寄費60元",
      "總額1020元"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "5260a329e9408b4873dc40ced28717345b572f25f7b7592225dad26157c45fd3",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "代入20；除4得5；5+7=12。所以答案是「正確，5＋7＝12」。",
    "steps": [
      "代入20",
      "除4得5",
      "5+7=12"
    ...
    "reviewStatus": "independently-reviewed",
    "noTemplateDeclaration": true,
    "contentSha256": "2fb343b6f662c7c43b641640602c679bedd5cee53b81ad6e1ccbe63000d6138a",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  }
];
...
export const CONSTRUCTED_RESPONSES = [
  {
    ...
    "fullCreditSolution": [
      "代入7：左邊4×5=20，右邊14+10=24，左右不等，所以7不是解。",
      "正確解：4x-8=2x+10，2x=18，x=9。",
      "驗算x=9時左右皆28。"
    ],
    ...
    "contentSha256": "b84c437a5403c0fa02f1e72323034afca137578bd1bc1768c00f2f0466ecc29e",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  },
  {
    ...
    "contentSha256": "8bf059c2d6011b9999449bb66a3820750432e0e0a2ad63ca3afb8116d29d35d0",
    "contentAuthority": "CHATGPT_HUMAN_AUTHORED_R1",
    "legacyContentDisposition": "replace-old-record-at-final-integration"
  }
];
