export const U09_PART_S010_S012 = [
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "8人70分，中位70較代表多數。平均74被95拉高；全距只表分散；眾數95只有2人。選代表要看一般水準而非少數高分。依題目所給數字列式計算，再對照所問的統計量作答。",
    "steps": [
      "8人70分，2人95分。",
      "中位70代表多數。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 3,
    "explanation": "5人樣本太小，60%可能是3人支持，應擴大樣本。立刻加課太草率；平均中位不適用此調查。決策前樣本要足夠。依題目所給數字列式計算，再對照所問的統計量作答。",
    "steps": [
      "只問5人。",
      "樣本太小。",
      "應擴大樣本再決定。"
  ...
  },
  {
    ...
    "answerIndex": 0,
    "explanation": "200則評論比10則可靠，A店較可信。B樣本小易受個別影響；平均相同；樣本大通常較穩定。依題目所給數字列式計算，再對照所問的統計量作答。",
    "steps": [
      "A有200則，B有10則。",
      "樣本大較可靠。",
      "A店較可信。"
  ...
  },
  {
    ...
    "answerIndex": 1,
    "explanation": "中位70代表中間水準，不受95影響。平均73被95拉高；全距只表分散；無眾數。有極端高分時中位較適合報一般水準。依題目所給數字列式計算，再對照所問的統計量作答。",
    "steps": [
      "有95極端高分。",
      "中位70較穩。",
      "中位數較適合。"
  ...
  },
  {
    ...
    "answerIndex": 2,
    "explanation": "下午5人最多，眾數是下午。上午4人次之；晚上3人；平均不適用類別偏好。類別資料用眾數找最多偏好。依題目所給數字列式計算，再對照所問的統計量作答。",
    "steps": [
      "下午5人最多。",
      "上午4、晚上3。",
      "下午較適合。"
