...
**wrong-option claim sentences:**
- 在評論來源與抽樣方式相近的前提下，A店有200則評論，B店只有10則
...
- 1: B校教學一定較好
- 2: 兩校進步率完全相同
- 3: A校進步率較高，但不能單憑比例判定教學成效
**answerIndex:** 3 → A校進步率較高，但不能單憑比例判定教學成效
