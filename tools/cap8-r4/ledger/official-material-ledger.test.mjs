...
test("checked-in index inventories and reviews every fixed material", async () => {
  ...
  await validateOfficialMaterialLedgerIndex(actual, snapshot, { requireComplete: true });
